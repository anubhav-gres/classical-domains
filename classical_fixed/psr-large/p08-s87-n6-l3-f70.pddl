(define (problem psr-s87-n6-l3-f70)
  (:domain psr)
  ...
  (:init
    ...
    (ext l3 sd6 side1)
    (ext l3 sd2 side1)
    (con sd6 side1 sd2 side1)
    (con sd2 side1 sd6 side1)
    (ext l3 sd3 side2)
    (con sd3 side2 sd2 side1)
    (con sd2 side1 sd3 side2)
    (con sd3 side2 sd6 side1)
    (con sd6 side1 sd3 side2)
    (ext l4 sd4 side2)
    (ext l4 sd3 side1)
    ...
    (ext l15 sd9 side1)
    (ext l15 sd18 side1)
    (con sd9 side1 sd18 side1)
    (con sd18 side1 sd9 side1)
    (ext l16 sd20 side2)
    (ext l16 cb4 side2)
    ...
    (ext l17 sd8 side1)
    (con sd8 side1 sd20 side1)
    (con sd20 side1 sd8 side1)
    ...
    (ext l18 sd14 side2)
    (con sd14 side2 sd21 side1)
    (con sd21 side1 sd14 side2)
    (con sd14 side2 sd22 side2)
    (con sd22 side2 sd14 side2)
    (ext l19 sd22 side1)
    (ext l19 cb5 side2)
    ...
    (ext l22 sd5 side1)
    (ext l22 sd26 side2)
    (con sd5 side1 sd26 side2)
    (con sd26 side2 sd5 side1)
    (ext l23 earth side2)
    (ext l23 sd6 side2)
