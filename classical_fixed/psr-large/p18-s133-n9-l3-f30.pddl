(define (problem psr-s133-n9-l3-f30)
  (:domain psr)
  ...
  (:init
    ...
    (ext l9 sd17 side2)
    (con sd17 side2 sd9 side1)
    (con sd9 side1 sd17 side2)
    (con sd17 side2 sd10 side2)
    (con sd10 side2 sd17 side2)
    (ext l10 sd11 side1)
    (ext l10 sd10 side1)
    ...
    (ext l13 sd3 side1)
    (ext l13 sd14 side1)
    (con sd3 side1 sd14 side1)
    (con sd14 side1 sd3 side1)
    (ext l14 sd18 side2)
    (ext l14 cb5 side2)
    (con sd18 side2 cb5 side2)
    (con cb5 side2 sd18 side2)
    (ext l14 sd15 side2)
    (con sd15 side2 cb5 side2)
    (con cb5 side2 sd15 side2)
    ...
    (ext l18 sd2 side2)
    (ext l18 sd19 side2)
    (con sd2 side2 sd19 side2)
    (con sd19 side2 sd2 side2)
    (ext l19 sd21 side1)
    (ext l19 sd20 side1)
    ...
    (ext l22 sd23 side2)
    (ext l22 cb7 side2)
    (con sd23 side2 cb7 side2)
    (con cb7 side2 sd23 side2)
    (ext l22 sd29 side2)
    (con sd29 side2 cb7 side2)
    (con cb7 side2 sd29 side2)
    (con sd29 side2 sd23 side2)
    (con sd23 side2 sd29 side2)
    (ext l23 sd13 side1)
    (ext l23 sd23 side1)
    ...
    (ext l24 sd24 side1)
    (ext l24 cb8 side2)
    (con sd24 side1 cb8 side2)
    (con cb8 side2 sd24 side1)
    (ext l25 sd25 side1)
    (ext l25 sd24 side2)
    ...
    (ext l26 sd32 side2)
    (ext l26 sd25 side2)
    (con sd32 side2 sd25 side2)
    (con sd25 side2 sd32 side2)
    (ext l27 sd30 side1)
    (ext l27 cb9 side2)
    ...
    (ext l31 sd21 side2)
    (ext l31 sd30 side2)
    (con sd21 side2 sd30 side2)
    (con sd30 side2 sd21 side2)
    (ext l31 sd31 side2)
    (con sd31 side2 sd30 side2)
    (con sd30 side2 sd31 side2)
    (con sd31 side2 sd21 side2)
    (con sd21 side2 sd31 side2)
    (ext l32 sd32 side1)
    (ext l32 sd31 side1)
