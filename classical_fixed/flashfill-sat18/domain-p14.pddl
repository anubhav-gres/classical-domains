...
(:constants
    a b d e f g h j k n o q r s t v x y z - char
    space - limiter
    str str2 - input
    res - output
    i0 i1 i10 i11 i12 i13 i2 i3 i4 i5 i6 i7 i8 i9 - index
...
(:action repeat-end-main-0-1
    ...
    (and
        ...
        (assignment str2 i1 z)
        (assignment str2 i2 h)
