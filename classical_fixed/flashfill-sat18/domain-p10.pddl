...
(:constants
    n0 n1 n2 n3 n4 n5 n6 n7 n8 - char
    colon dot lpar - limiter
    str - input
    res - output
...
(:action repeat-end-main-0-1
    ...
    (and
        ...
        (ins-end-1)
        (test-0)
        (assignment res i0 n0)
        (assignment res i1 n2)
    )
    :effect
    (and
        (not (test-0))
        ...
        (assignment str i5 n1)
        (assignment str i6 n0)
...
(:action repeat-end-main-1-1
    ...
    (and
        ...
        (assignment str i1 colon)
        (assignment str i2 n2)
        (assignment str i3 n7)
        (assignment str i4 dot)
        (assignment str i5 n4)
