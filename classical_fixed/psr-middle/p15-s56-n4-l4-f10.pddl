(define (problem psr-s56-n4-l4-f10)
  (:domain psr)
  (:objects cb1 cb2 cb3 cb4
            ...
            l1 l2 l3 l4 l5 l6 l7 l8 l9 l10 l11 l12 l13 l14 l15 l16 l17 l18 l19 l20 l21 l22 l23 - line
  )
  (:init
    (breaker cb1)
    (breaker cb2)
    ...
    (con sd11 side1 sd6 side2)
    (con sd6 side2 sd11 side1)
    (ext l8 sd9 side2)
    (ext l8 sd11 side2)
    ...
    (ext l12 sd8 side2)
    (ext l12 sd15 side1)
    (con sd8 side2 sd15 side1)
    (con sd15 side1 sd8 side2)
    (ext l13 sd17 side2)
    (ext l13 cb4 side2)
    ...
    (ext l14 sd24 side1)
    (ext l14 sd17 side1)
    (con sd24 side1 sd17 side1)
    (con sd17 side1 sd24 side1)
    (ext l14 sd18 side2)
    ...
    (ext l19 sd2 side1)
    (ext l19 sd22 side1)
    (con sd2 side1 sd22 side1)
    (con sd22 side1 sd2 side1)
    (ext l20 sd16 side2)
    (ext l20 sd24 side2)
    (con sd16 side2 sd24 side2)
    (con sd24 side2 sd16 side2)
    (ext l21 earth side2)
    (ext l21 sd4 side1)
