(define (problem psr-s120-n8-l4-f10)
  (:domain psr)
  (:objects cb1 cb2 cb3 cb4 cb5 cb6 cb7 cb8
            sd1 sd2 sd3 sd4 sd5 sd6 sd7 sd8 sd9 sd10 sd11 sd12 sd13 sd14 sd15 sd16 sd17 sd18 sd19 sd20 sd21 sd22 sd23 sd24 sd25 sd26 sd27 sd28 sd29 sd30 sd31 sd32 sd33 sd34 sd35 sd36 sd37 sd38 - device
  ...
  (:init
    ...
    (ext l1 sd4 side2)
    (ext l1 cb1 side2)
    (con sd4 side2 cb1 side2)
    (con cb1 side2 sd4 side2)
    (ext l1 sd1 side2)
    ...
    (ext l4 sd14 side1)
    (ext l4 cb2 side2)
    (con sd14 side1 cb2 side2)
    (con cb2 side2 sd14 side1)
    (ext l4 sd5 side2)
    (con sd5 side2 cb2 side2)
    (con cb2 side2 sd5 side2)
    (con sd5 side2 sd14 side1)
    (con sd14 side1 sd5 side2)
    (ext l5 sd7 side1)
    (ext l5 sd5 side1)
    ...
    (ext l9 sd27 side1)
    (ext l9 sd10 side2)
    (con sd27 side1 sd10 side2)
    (con sd10 side2 sd27 side1)
    (ext l10 sd12 side2)
    (ext l10 sd11 side2)
    ...
    (ext l16 sd34 side2)
    (con sd34 side2 sd18 side1)
    (con sd18 side1 sd34 side2)
    ...
    (ext l17 sd4 side1)
    (con sd4 side1 sd20 side1)
    (con sd20 side1 sd4 side1)
    (con sd4 side1 sd21 side2)
    (con sd21 side2 sd4 side1)
    (ext l18 sd22 side2)
    (ext l18 cb5 side2)
    ...
    (ext l21 sd6 side1)
    (ext l21 sd24 side1)
    (con sd6 side1 sd24 side1)
    (con sd24 side1 sd6 side1)
    (ext l22 sd29 side2)
    (ext l22 cb6 side2)
    ...
    (con sd25 side2 sd29 side2)
    (con sd29 side2 sd25 side2)
    (con sd25 side2 sd28 side2)
    (con sd28 side2 sd25 side2)
    (ext l23 sd26 side1)
    (ext l23 sd25 side1)
    ...
    (ext l24 sd38 side1)
    (con sd38 side1 sd26 side2)
    (con sd26 side2 sd38 side1)
    (con sd38 side1 sd27 side2)
    (con sd27 side2 sd38 side1)
    (ext l25 sd30 side2)
    (ext l25 sd29 side1)
    ...
    (ext l27 sd36 side1)
    (ext l27 cb7 side2)
    (con sd36 side1 cb7 side2)
    (con cb7 side2 sd36 side1)
    (ext l27 sd32 side1)
    (con sd32 side1 cb7 side2)
    (con cb7 side2 sd32 side1)
    (con sd32 side1 sd36 side1)
    (con sd36 side1 sd32 side1)
    (ext l28 sd35 side1)
    (ext l28 sd32 side2)
    ...
    (con sd3 side2 sd35 side1)
    (con sd35 side1 sd3 side2)
    (ext l28 sd33 side1)
    (con sd33 side1 sd32 side2)
    (con sd32 side2 sd33 side1)
    (con sd33 side1 sd35 side1)
    (con sd35 side1 sd33 side1)
    (con sd33 side1 sd3 side2)
    (con sd3 side2 sd33 side1)
    (ext l29 sd19 side2)
    (ext l29 sd33 side2)
    ...
    (con sd34 side1 sd19 side2)
    (con sd19 side2 sd34 side1)
    (ext l30 sd13 side1)
    (ext l30 sd35 side2)
    (con sd13 side1 sd35 side2)
    (con sd35 side2 sd13 side1)
    (ext l31 sd21 side1)
    (ext l31 cb8 side2)
    (con sd21 side1 cb8 side2)
    (con cb8 side2 sd21 side1)
    (ext l31 sd37 side1)
    ...
    (ext l32 sd28 side1)
    (ext l32 sd37 side2)
    (con sd28 side1 sd37 side2)
    (con sd37 side2 sd28 side1)
    (ext l32 sd38 side2)
    (con sd38 side2 sd37 side2)
    (con sd37 side2 sd38 side2)
    (con sd38 side2 sd28 side1)
    (con sd28 side1 sd38 side2)
    (ext l33 earth side2)
    (ext l33 sd36 side2)
