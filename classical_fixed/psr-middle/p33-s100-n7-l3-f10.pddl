(define (problem psr-s100-n7-l3-f10)
  (:domain psr)
  (:objects cb1 cb2 cb3 cb4 cb5 cb6 cb7
            sd1 sd2 sd3 sd4 sd5 sd6 sd7 sd8 sd9 sd10 sd11 sd12 sd13 sd14 sd15 sd16 sd17 sd18 sd19 sd20 sd21 sd22 sd23 sd24 sd25 sd26 sd27 sd28 sd29 sd30 sd31 sd32 - device
  ...
  (:init
    ...
    (ext l10 sd6 side1)
    (con sd6 side1 sd13 side1)
    (con sd13 side1 sd6 side1)
    (con sd6 side1 sd14 side1)
    (con sd14 side1 sd6 side1)
    (ext l11 sd15 side1)
    (ext l11 sd14 side2)
    ...
    (ext l12 sd32 side2)
    (ext l12 cb3 side2)
    (con sd32 side2 cb3 side2)
    (con cb3 side2 sd32 side2)
    (ext l12 sd16 side1)
    (con sd16 side1 cb3 side2)
    (con cb3 side2 sd16 side1)
    (con sd16 side1 sd32 side2)
    (con sd32 side2 sd16 side1)
    (ext l13 sd17 side2)
    (ext l13 sd16 side2)
    ...
    (ext l21 sd18 side1)
    (ext l21 sd24 side1)
    (con sd18 side1 sd24 side1)
    (con sd24 side1 sd18 side1)
    (ext l21 sd25 side1)
    (con sd25 side1 sd24 side1)
    (con sd24 side1 sd25 side1)
    (con sd25 side1 sd18 side1)
    (con sd18 side1 sd25 side1)
    (ext l22 sd26 side1)
    (ext l22 cb6 side2)
    ...
    (ext l24 sd31 side2)
    (ext l24 sd27 side1)
    (con sd31 side2 sd27 side1)
    (con sd27 side1 sd31 side2)
    (ext l24 sd28 side1)
    (con sd28 side1 sd27 side1)
    (con sd27 side1 sd28 side1)
    (con sd28 side1 sd31 side2)
    (con sd31 side2 sd28 side1)
    (ext l25 sd30 side1)
    (ext l25 sd28 side2)
    ...
    (ext l26 sd22 side2)
    (ext l26 sd30 side2)
    (con sd22 side2 sd30 side2)
    (con sd30 side2 sd22 side2)
    (ext l27 sd32 side1)
    (ext l27 cb7 side2)
    ...
    (ext l27 sd12 side2)
    (con sd12 side2 cb7 side2)
    (con cb7 side2 sd12 side2)
    (con sd12 side2 sd32 side1)
    (con sd32 side1 sd12 side2)
    (con sd12 side2 sd31 side1)
    (con sd31 side1 sd12 side2)
    (ext l28 earth side2)
    (ext l28 sd2 side2)
    (con earth side2 sd2 side2)
    (con sd2 side2 earth side2)
    (ext l29 earth side2)
    (ext l29 sd7 side2)
    ...
    (ext l30 earth side2)
    (ext l30 sd9 side2)
    (con earth side2 sd9 side2)
    (con sd9 side2 earth side2)
    (ext l31 earth side2)
    (ext l31 sd25 side2)
