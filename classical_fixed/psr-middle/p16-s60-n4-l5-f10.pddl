(define (problem psr-s60-n4-l5-f10)
  (:domain psr)
  ...
  (:init
    ...
    (con sd7 side1 sd11 side2)
    (con sd11 side2 sd7 side1)
    (ext l7 sd8 side1)
    (ext l7 sd7 side2)
    ...
    (ext l13 sd5 side2)
    (ext l13 sd15 side2)
    (con sd5 side2 sd15 side2)
    (con sd15 side2 sd5 side2)
    (ext l13 sd16 side1)
    (con sd16 side1 sd15 side2)
    (con sd15 side2 sd16 side1)
    (con sd16 side1 sd5 side2)
    (con sd5 side2 sd16 side1)
    (ext l14 sd17 side2)
    (ext l14 sd16 side2)
    ...
    (ext l19 sd11 side1)
    (ext l19 sd21 side1)
    (con sd11 side1 sd21 side1)
    (con sd21 side1 sd11 side1)
    (ext l19 sd22 side1)
    (con sd22 side1 sd21 side1)
    (con sd21 side1 sd22 side1)
    (con sd22 side1 sd11 side1)
    (con sd11 side1 sd22 side1)
    (ext l20 sd23 side2)
    (ext l20 sd22 side2)
    ...
    (ext l21 sd18 side2)
    (ext l21 sd23 side1)
    (con sd18 side2 sd23 side1)
    (con sd23 side1 sd18 side2)
    (ext l22 earth side2)
    (ext l22 sd9 side2)
