(define (problem psr-s55-n4-l3-f70)
  (:domain psr)
  (:objects cb1 cb2 cb3 cb4
            sd1 sd2 sd3 sd4 sd5 sd6 sd7 sd8 sd9 sd10 sd11 sd12 sd13 sd14 sd15 sd16 sd17 sd18 sd19 sd20 sd21 sd22 - device
  ...
  (:init
    ...
    (ext l6 sd7 side1)
    (ext l6 cb3 side2)
    (con sd7 side1 cb3 side2)
    (con cb3 side2 sd7 side1)
    (ext l6 sd10 side1)
    ...
    (ext l8 sd3 side2)
    (ext l8 sd10 side2)
    (con sd3 side2 sd10 side2)
    (con sd10 side2 sd3 side2)
    (ext l8 sd11 side1)
    (con sd11 side1 sd10 side2)
    (con sd10 side2 sd11 side1)
    (con sd11 side1 sd3 side2)
    (con sd3 side2 sd11 side1)
    (ext l9 sd15 side2)
    (ext l9 sd11 side2)
    ...
    (con sd16 side1 sd21 side2)
    (con sd21 side2 sd16 side1)
    ...
    (ext l20 earth side2)
    (ext l20 sd4 side2)
    (con earth side2 sd4 side2)
    (con sd4 side2 earth side2)
    (ext l21 earth side2)
    (ext l21 sd15 side1)
