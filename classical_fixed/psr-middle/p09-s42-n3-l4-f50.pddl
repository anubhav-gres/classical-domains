(define (problem psr-s42-n3-l4-f50)
  (:domain psr)
  (:objects cb1 cb2 cb3
  ...
  (:init
    ...
    (ext l6 sd3 side1)
    (ext l6 sd6 side2)
    (con sd3 side1 sd6 side2)
    (con sd6 side2 sd3 side1)
    (ext l6 sd7 side2)
    (con sd7 side2 sd6 side2)
    (con sd6 side2 sd7 side2)
    (con sd7 side2 sd3 side1)
    (con sd3 side1 sd7 side2)
    (ext l7 sd9 side2)
    (ext l7 sd8 side1)
    ...
    (con sd10 side1 sd5 side2)
    (con sd5 side2 sd10 side1)
    (con sd10 side1 sd11 side2)
    (con sd11 side2 sd10 side1)
    (ext l9 sd7 side1)
    (ext l9 sd10 side2)
    (con sd7 side1 sd10 side2)
    (con sd10 side2 sd7 side1)
    (ext l10 earth side2)
    (ext l10 sd11 side1)
