(define (problem psr-s116-n8-l3-f10)
  (:domain psr)
  ...
  (:init
    ...
    (ext l9 sd4 side1)
    (ext l9 sd10 side2)
    (con sd4 side1 sd10 side2)
    (con sd10 side2 sd4 side1)
    (ext l10 sd17 side1)
    (ext l10 cb4 side2)
    (con sd17 side1 cb4 side2)
    (con cb4 side2 sd17 side1)
    (ext l10 sd11 side1)
    (con sd11 side1 cb4 side2)
    (con cb4 side2 sd11 side1)
    (con sd11 side1 sd17 side1)
    (con sd17 side1 sd11 side1)
    (ext l11 sd29 side2)
    (ext l11 sd11 side2)
    (con sd29 side2 sd11 side2)
    (con sd11 side2 sd29 side2)
    (ext l11 sd12 side2)
    (con sd12 side2 sd11 side2)
    (con sd11 side2 sd12 side2)
    (con sd12 side2 sd29 side2)
    (con sd29 side2 sd12 side2)
    (ext l12 sd13 side2)
    (ext l12 sd12 side1)
    ...
    (ext l20 sd22 side1)
    (con sd22 side1 cb6 side2)
    (con cb6 side2 sd22 side1)
    ...
    (ext l21 sd7 side1)
    (ext l21 sd23 side2)
    (con sd7 side1 sd23 side2)
    (con sd23 side2 sd7 side1)
    (ext l22 sd25 side1)
    (ext l22 sd24 side2)
    ...
    (con sd27 side2 sd30 side1)
    (con sd30 side1 sd27 side2)
    (ext l25 sd29 side1)
    (ext l25 sd27 side1)
    ...
    (ext l26 sd33 side1)
    (ext l26 cb7 side2)
    (con sd33 side1 cb7 side2)
    (con cb7 side2 sd33 side1)
    (ext l26 sd31 side2)
    ...
    (ext l29 sd3 side2)
    (ext l29 sd34 side2)
    (con sd3 side2 sd34 side2)
    (con sd34 side2 sd3 side2)
    (ext l30 sd21 side1)
    (ext l30 sd35 side1)
    (con sd21 side1 sd35 side1)
    (con sd35 side1 sd21 side1)
    (ext l31 sd36 side1)
    (ext l31 cb8 side2)
    ...
    (ext l32 sd22 side2)
    (ext l32 sd36 side2)
    (con sd22 side2 sd36 side2)
    (con sd36 side2 sd22 side2)
    (ext l32 sd18 side2)
    (con sd18 side2 sd36 side2)
    (con sd36 side2 sd18 side2)
