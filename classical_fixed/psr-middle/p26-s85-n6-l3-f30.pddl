(define (problem psr-s85-n6-l3-f30)
  (:domain psr)
  ...
  (:init
    ...
    (con sd7 side2 sd7 side1)
    (con sd7 side1 sd7 side2)
    ...
    (ext l8 sd18 side1)
    (ext l8 cb3 side2)
    (con sd18 side1 cb3 side2)
    (con cb3 side2 sd18 side1)
    (ext l8 sd12 side2)
    (con sd12 side2 cb3 side2)
    (con cb3 side2 sd12 side2)
    (con sd12 side2 sd18 side1)
    (con sd18 side1 sd12 side2)
    (ext l9 sd15 side1)
    (ext l9 sd12 side1)
    ...
    (ext l14 sd11 side1)
    (ext l14 sd19 side1)
    (con sd11 side1 sd19 side1)
    (con sd19 side1 sd11 side1)
    (ext l15 sd20 side2)
    (ext l15 cb5 side2)
    ...
    (ext l19 sd10 side1)
    (ext l19 sd23 side2)
    (con sd10 side1 sd23 side2)
    (con sd23 side2 sd10 side1)
    (ext l19 sd24 side1)
    (con sd24 side1 sd23 side2)
    (con sd23 side2 sd24 side1)
    (con sd24 side1 sd10 side1)
    (con sd10 side1 sd24 side1)
    (ext l20 sd25 side1)
    (ext l20 sd24 side2)
    ...
    (ext l21 sd8 side1)
    (ext l21 sd25 side2)
    (con sd8 side1 sd25 side2)
    (con sd25 side2 sd8 side1)
    (ext l22 earth side2)
    (ext l22 sd5 side2)
    (con earth side2 sd5 side2)
    (con sd5 side2 earth side2)
    (ext l23 earth side2)
    (ext l23 sd18 side2)
