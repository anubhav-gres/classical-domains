...
(:init
		...
		(prevsheet sheet13 sheet12)
		(prevsheet sheet14 sheet13)
		(prevsheet sheet15 sheet14)
		...
		(sheetsize sheet13 letter)
		(sheetsize sheet14 letter)
		(sheetsize sheet15 letter)
		...
		(location sheet13 some_feeder_tray)
		(location sheet14 some_feeder_tray)
		(location sheet15 some_feeder_tray)
		...
		(imagecolor image-13 black)
		(imagecolor image-14 black)
		(imagecolor image-15 black)
		...
		(notprintedwith sheet13 front black)
		(notprintedwith sheet13 back black)
		(notprintedwith sheet13 front color)
		(notprintedwith sheet13 back color)
		(notprintedwith sheet14 front black)
		(notprintedwith sheet14 back black)
		(notprintedwith sheet14 front color)
		(notprintedwith sheet14 back color)
		(notprintedwith sheet15 front black)
		(notprintedwith sheet15 back black)
		(notprintedwith sheet15 front color)
		(notprintedwith sheet15 back color)
...
(:goal (and
		...
		(notprintedwith sheet12 back black)
		(notprintedwith sheet12 back color)
		(hasimage sheet13 front image-13)
		(notprintedwith sheet13 front color)
		(notprintedwith sheet13 back black)
		(notprintedwith sheet13 back color)
		(hasimage sheet14 front image-14)
		(notprintedwith sheet14 front color)
		(notprintedwith sheet14 back black)
		(notprintedwith sheet14 back color)
		(hasimage sheet15 front image-15)
		(notprintedwith sheet15 front color)
		(notprintedwith sheet15 back black)
		(notprintedwith sheet15 back color)
		(sideup sheet1 front)
		...
		(sideup sheet13 front)
		(sideup sheet14 front)
		(sideup sheet15 front)
		...
		(stackedin sheet13 finisher1_tray)
		(stackedin sheet14 finisher1_tray)
		(stackedin sheet15 finisher1_tray)
)
)
