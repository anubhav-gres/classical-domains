...
(:action close_sd12-condeff1-no-1
:parameters ()
:precondition
(and
(do-close_sd12-condeffs)
...
(:action close_sd12-condeff1-no-2
:parameters ()
:precondition
(and
(do-close_sd12-condeffs)
...
(:action close_sd12-condeff2-yes
:parameters ()
:precondition
(and
(do-close_sd12-condeffs)
...
(:action close_sd12-condeff2-no-0
:parameters ()
:precondition
(and
(do-close_sd12-condeffs)
...
(:action close_sd12-condeff2-no-1
:parameters ()
:precondition
(and
(do-close_sd12-condeffs)
...
(:action close_sd11-condeff2-yes
:parameters ()
:precondition
(and
(do-close_sd11-condeffs)
...
(:action close_sd11-condeff2-no-0
:parameters ()
:precondition
(and
(do-close_sd11-condeffs)
...
(:action close_sd11-condeff2-no-1
:parameters ()
:precondition
(and
(do-close_sd11-condeffs)
...
(:action close_sd11-condeff2-no-2
:parameters ()
:precondition
(and
(do-close_sd11-condeffs)
