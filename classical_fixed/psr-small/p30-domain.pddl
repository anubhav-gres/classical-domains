...
(:action close_sd8-condeff2-no-0
:parameters ()
:precondition
(and
(do-close_sd8-condeffs)
...
(:action close_sd8-condeff2-no-1
:parameters ()
:precondition
(and
(do-close_sd8-condeffs)
...
(:action close_sd8-condeff2-no-2
:parameters ()
:precondition
(and
(do-close_sd8-condeffs)
