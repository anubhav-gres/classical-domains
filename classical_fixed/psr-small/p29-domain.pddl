...
(:action close_sd19-condeff0-no-4
:parameters ()
:precondition
(and
(do-close_sd19-condeffs)
...
(:action close_sd19-condeff0-no-5
:parameters ()
:precondition
(and
(do-close_sd19-condeffs)
...
(:action close_sd13-condeff0-no-5
:parameters ()
:precondition
(and
(do-close_sd13-condeffs)
...
(:action close_sd6-condeff0-no-5
:parameters ()
:precondition
(and
(do-close_sd6-condeffs)
...
(:action close_sd4-condeff0-no-5
:parameters ()
:precondition
(and
(do-close_sd4-condeffs)
...
(:action close_sd3-condeff0-no-5
:parameters ()
:precondition
(and
(do-close_sd3-condeffs)
...
(:action close_sd2-condeff0-no-4
:parameters ()
:precondition
(and
(do-close_sd2-condeffs)
...
(:action close_sd2-condeff0-no-5
:parameters ()
:precondition
(and
(do-close_sd2-condeffs)
...
(:action close_sd1-condeff0-no-4
:parameters ()
:precondition
(and
(do-close_sd1-condeffs)
...
(:action close_sd1-condeff0-no-5
:parameters ()
:precondition
(and
(do-close_sd1-condeffs)
...
(:action close_sd1-condeff1-no-5
:parameters ()
:precondition
(and
(do-close_sd1-condeffs)
...
(:action close_sd5-condeff0-no-5
:parameters ()
:precondition
(and
(do-close_sd5-condeffs)
