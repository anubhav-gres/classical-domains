...
(:action close_sd1-condeff3-no-0
:parameters ()
:precondition
(and
(do-close_sd1-condeffs)
...
(:action close_sd1-condeff3-no-1
:parameters ()
:precondition
(and
(do-close_sd1-condeffs)
