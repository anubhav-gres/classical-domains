;; generator input: seed=140911, locations=5, edges=5, seas=1, probabilities=[2, 3, 3, 4], goals=6, optimization=[5, 10], c=1.500000, v=1.500000
(define (problem psat-small-06-medium)
(:domain settlers)
(:objects
