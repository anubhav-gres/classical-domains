;; generator input: seed=270683, locations=16, edges=18, seas=2, probabilities=[2, 3, 3, 4], goals=4, optimization=[5, 10], c=1.500000, v=1.500000
(define (problem psat-huge-04-medium)
(:domain settlers)
(:objects
...
(:init
    ...
    (available-stone p7 sl9)
    (available-atleast-stone p7 sl1)
    (available-atleast-stone p7 sl2)
    (available-atleast-stone p7 sl4)
...
(and
    (has-ironworks p13)
    (connected-by-rail p14 p3)
    (connected-by-rail p15 p11)
    (housing p0 hl1)
)
)
