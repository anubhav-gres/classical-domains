;; generator input: seed=230813, locations=8, edges=9, seas=1, probabilities=[2, 3, 3, 4], goals=8, optimization=[5, 10], c=1.500000, v=1.500000
(define (problem psat-large-08-medium)
(:domain settlers)
(:objects
...
(:goal
(and
    (connected-by-rail p5 p7)
    (connected-by-rail p0 p7)
    (has-coal-stack p3)
