;; generator input: seed=190177, locations=8, edges=9, seas=1, probabilities=[2, 3, 3, 4], goals=4, optimization=[5, 10], c=1.500000, v=1.500000
(define (problem psat-large-04-medium)
(:domain settlers)
(:objects
...
(:init
    ...
    (available-ore p2 ol8)
    (available-atleast-ore p2 ol1)
    (available-atleast-ore p2 ol2)
    (available-atleast-ore p2 ol4)
    (available-wood p2 wl0)
    (available-coal p2 cl0)
    (available-iron p2 il0)
    (available-stone p3 sl9)
