;; generator input: seed=280511, locations=16, edges=18, seas=2, probabilities=[2, 3, 3, 4], goals=5, optimization=[5, 10], c=1.500000, v=1.500000
(define (problem psat-huge-05-medium)
(:domain settlers)
(:objects
    ...
    cl11 cl12 cl13 cl14 cl15 cl16 cl17 cl18 cl19 cl20 cl21 cl22 cl23 cl24 cl25 cl26 cl27 - coal_level
    wl11 wl12 wl13 wl14 wl15 wl16 wl17 wl18 wl19 wl20 wl21 wl22 wl23 wl24 wl25 wl26 wl27 - wood_level
    tl11 tl12 tl13 tl14 tl15 tl16 tl17 tl18 tl19 tl20 tl21 tl22 tl23 tl24 tl25 tl26 tl27 - timber_level
)
(:init
    (connected-by-land p0 p3)
    (connected-by-land p0 p6)
    (connected-by-land p0 p9)
    (connected-by-land p0 p12)
    (connected-by-land p0 p13)
    (connected-by-land p1 p7)
    ...
    (connected-by-land p5 p6)
    (connected-by-land p6 p0)
    (connected-by-land p6 p2)
    (connected-by-land p6 p5)
    (connected-by-land p7 p1)
    (connected-by-land p7 p4)
    (connected-by-land p7 p15)
    (connected-by-land p8 p4)
    (connected-by-land p9 p0)
    (connected-by-land p9 p1)
    (connected-by-land p10 p13)
    (connected-by-land p11 p2)
    (connected-by-land p12 p0)
    (connected-by-land p13 p0)
    (connected-by-land p13 p10)
    (connected-by-land p13 p14)
    (connected-by-land p13 p15)
    (connected-by-land p14 p4)
    (connected-by-land p14 p13)
    (connected-by-land p15 p7)
    (connected-by-land p15 p13)
    (connected-by-sea p1 p15)
    (connected-by-sea p15 p1)
    (connected-by-sea p2 p4)
    (connected-by-sea p2 p9)
    (connected-by-sea p2 p12)
    (connected-by-sea p4 p2)
    (connected-by-sea p4 p9)
    (connected-by-sea p4 p12)
    (connected-by-sea p9 p2)
    (connected-by-sea p9 p4)
    (connected-by-sea p9 p12)
    (connected-by-sea p12 p2)
    (connected-by-sea p12 p4)
    (connected-by-sea p12 p9)
    (by-coast p1)
    (by-coast p2)
    (by-coast p4)
    (by-coast p9)
    ...
    (available-stone p2 sl12)
    (available-atleast-stone p2 sl1)
    (available-atleast-stone p2 sl2)
    (available-atleast-stone p2 sl4)
    ...
    (available-ore p7 ol8)
    (available-atleast-ore p7 ol1)
    (available-atleast-ore p7 ol2)
    (available-atleast-ore p7 ol4)
...
(and
    (has-ironworks p13)
    (has-ironworks p10)
    (connected-by-rail p14 p4)
    (connected-by-rail p9 p1)
    (housing p10 hl1)
)
)
