;; generator input: seed=290673, locations=16, edges=18, seas=2, probabilities=[2, 3, 3, 4], goals=6, optimization=[5, 10], c=1.500000, v=1.500000
(define (problem psat-huge-06-medium)
(:domain settlers)
(:objects
    ...
    sl11 - stone_level
    hl11 - housing_level
    cl11 cl12 cl13 cl14 cl15 cl16 cl17 cl18 cl19 cl20 cl21 cl22 cl23 cl24 cl25 cl26 cl27 cl28 cl29 cl30 - coal_level
    wl11 wl12 wl13 wl14 wl15 wl16 wl17 wl18 wl19 wl20 wl21 wl22 wl23 wl24 wl25 wl26 wl27 wl28 wl29 wl30 - wood_level
    tl11 tl12 tl13 tl14 tl15 tl16 tl17 tl18 tl19 tl20 tl21 tl22 tl23 tl24 tl25 tl26 tl27 tl28 tl29 tl30 - timber_level
)
(:init
    (connected-by-land p0 p1)
    (connected-by-land p0 p5)
    (connected-by-land p0 p7)
    (connected-by-land p0 p10)
    (connected-by-land p0 p14)
    (connected-by-land p1 p0)
    (connected-by-land p2 p11)
    (connected-by-land p2 p13)
    (connected-by-land p2 p15)
    (connected-by-land p3 p7)
    (connected-by-land p3 p11)
    (connected-by-land p4 p6)
    (connected-by-land p5 p0)
    (connected-by-land p5 p10)
    (connected-by-land p5 p12)
    (connected-by-land p6 p4)
    (connected-by-land p6 p9)
    (connected-by-land p7 p0)
    (connected-by-land p7 p3)
    (connected-by-land p8 p10)
    (connected-by-land p8 p12)
    (connected-by-land p9 p6)
    (connected-by-land p9 p10)
    (connected-by-land p10 p0)
    ...
    (connected-by-land p12 p5)
    (connected-by-land p12 p8)
    (connected-by-land p12 p10)
    (connected-by-land p13 p2)
    (connected-by-land p14 p0)
    (connected-by-land p15 p2)
    (connected-by-sea p1 p4)
    (connected-by-sea p1 p5)
    (connected-by-sea p1 p9)
    (connected-by-sea p1 p14)
    (connected-by-sea p1 p15)
    (connected-by-sea p4 p1)
    (connected-by-sea p4 p5)
    (connected-by-sea p4 p9)
    (connected-by-sea p4 p14)
    (connected-by-sea p4 p15)
    (connected-by-sea p5 p1)
    (connected-by-sea p5 p4)
    (connected-by-sea p5 p9)
    (connected-by-sea p5 p14)
    (connected-by-sea p5 p15)
    (connected-by-sea p9 p1)
    (connected-by-sea p9 p4)
    (connected-by-sea p9 p5)
    (connected-by-sea p9 p14)
    (connected-by-sea p9 p15)
    (connected-by-sea p14 p1)
    (connected-by-sea p14 p4)
    (connected-by-sea p14 p5)
    (connected-by-sea p14 p9)
    (connected-by-sea p14 p15)
    (connected-by-sea p15 p1)
    (connected-by-sea p15 p4)
    (connected-by-sea p15 p5)
...
(and
    (has-ironworks p6)
    (connected-by-rail p6 p9)
    (connected-by-rail p4 p6)
    (connected-by-rail p3 p7)
    (housing p8 hl1)
    (housing p2 hl1)
)
)
