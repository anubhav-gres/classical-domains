;; generator input: seed=210953, locations=8, edges=9, seas=1, probabilities=[2, 3, 3, 4], goals=6, optimization=[5, 10], c=1.500000, v=1.500000
(define (problem psat-large-06-medium)
(:domain settlers)
(:objects
    ...
    sl11 - stone_level
    hl11 - housing_level
    cl11 cl12 cl13 cl14 cl15 cl16 cl17 cl18 cl19 cl20 cl21 cl22 cl23 cl24 cl25 cl26 cl27 cl28 cl29 - coal_level
    wl11 wl12 wl13 wl14 wl15 wl16 wl17 wl18 wl19 wl20 wl21 wl22 wl23 wl24 wl25 wl26 wl27 wl28 wl29 - wood_level
    tl11 tl12 tl13 tl14 tl15 tl16 tl17 tl18 tl19 tl20 tl21 tl22 tl23 tl24 tl25 tl26 tl27 tl28 tl29 - timber_level
)
(:init
    ...
    (connected-by-sea p3 p5)
    (connected-by-sea p3 p6)
    (connected-by-sea p5 p1)
    (connected-by-sea p5 p3)
...
(:goal
(and
    (connected-by-rail p0 p5)
    (has-sawmill p3)
    (has-sawmill p1)
    (connected-by-rail p1 p5)
    (housing p0 hl1)
    (housing p2 hl1)
)
)
