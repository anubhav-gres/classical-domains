;; generator input: seed=300742, locations=16, edges=18, seas=2, probabilities=[2, 3, 3, 4], goals=7, optimization=[5, 10], c=1.500000, v=1.500000
(define (problem psat-huge-07-medium)
(:domain settlers)
(:objects
    p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14 p15 - place
    v0 v1 v2 v3 - vehicle
    cl11 cl12 cl13 cl14 cl15 cl16 cl17 cl18 cl19 cl20 cl21 cl22 cl23 cl24 cl25 cl26 cl27 cl28 cl29 cl30 cl31 cl32 cl33 - coal_level
    wl11 wl12 wl13 wl14 wl15 wl16 wl17 wl18 wl19 wl20 wl21 wl22 wl23 wl24 wl25 wl26 wl27 wl28 wl29 wl30 wl31 wl32 wl33 - wood_level
    il11 - iron_level
    ol11 - ore_level
    tl11 tl12 tl13 tl14 tl15 tl16 tl17 tl18 tl19 tl20 tl21 tl22 tl23 tl24 tl25 tl26 tl27 tl28 tl29 tl30 tl31 tl32 tl33 - timber_level
)
(:init
    ...
    (connected-by-land p1 p9)
    (connected-by-land p2 p11)
    (connected-by-land p3 p11)
    (connected-by-land p4 p8)
    (connected-by-land p4 p15)
    (connected-by-land p5 p10)
    (connected-by-land p5 p15)
    (connected-by-land p6 p1)
    (connected-by-land p6 p11)
    (connected-by-land p6 p12)
    (connected-by-land p7 p0)
    (connected-by-land p7 p11)
    (connected-by-land p7 p14)
    (connected-by-land p8 p1)
    (connected-by-land p8 p4)
    (connected-by-land p8 p10)
    (connected-by-land p8 p12)
    (connected-by-land p9 p1)
    (connected-by-land p10 p5)
    (connected-by-land p10 p8)
    (connected-by-land p10 p12)
    (connected-by-land p11 p2)
    (connected-by-land p11 p3)
    (connected-by-land p11 p6)
    (connected-by-land p11 p7)
    (connected-by-land p12 p6)
    (connected-by-land p12 p8)
    (connected-by-land p12 p10)
    (connected-by-land p14 p7)
    (connected-by-land p15 p4)
    (connected-by-land p15 p5)
    (connected-by-sea p1 p6)
    (connected-by-sea p1 p13)
    (connected-by-sea p6 p1)
    (connected-by-sea p6 p13)
    (connected-by-sea p13 p1)
    (connected-by-sea p13 p6)
    ...
    (available-stone p5 sl9)
    (available-atleast-stone p5 sl1)
    (available-atleast-stone p5 sl2)
    (available-atleast-stone p5 sl4)
    ...
    (available-ore p6 ol11)
    (available-atleast-ore p6 ol1)
    (available-atleast-ore p6 ol2)
    (available-atleast-ore p6 ol4)
...
(and
    (has-sawmill p9)
    (connected-by-rail p3 p11)
    (connected-by-rail p1 p9)
    (connected-by-rail p8 p12)
    (connected-by-rail p11 p2)
    (has-ironworks p4)
    (housing p14 hl1)
)
)
