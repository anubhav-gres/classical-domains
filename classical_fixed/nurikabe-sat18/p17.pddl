(define (problem random-14x14-21097)
(:domain nurikabe)
(:objects
    ...
    g0 g1 g2 g3 g4 g5 g6 g7 g8 g9 g10 g11 g12 g13 g14 g15 g16 g17 g18 g19 g20 g21 g22 - group
)
(:init
    (next n0 n1)
    (next n1 n2)
    ...
    (source pos-3-9 g16)
    (source pos-5-9 g17)
    (source pos-11-10 g18)
    (source pos-13-10 g19)
    (source pos-6-11 g20)
    (source pos-8-12 g21)
    (source pos-12-13 g22)
    (available pos-0-0)
    (available pos-0-4)
    (available pos-0-6)
    (available pos-0-7)
    ...
    (part-of pos-0-5 g11)
    (part-of pos-1-4 g11)
    (part-of pos-13-5 g12)
    (part-of pos-12-6 g12)
    (part-of pos-11-5 g12)
    (part-of pos-5-7 g13)
    (part-of pos-6-6 g13)
    (part-of pos-7-9 g14)
    (part-of pos-10-8 g15)
    (part-of pos-9-9 g15)
    (part-of pos-9-7 g15)
    (part-of pos-3-10 g16)
    (part-of pos-2-9 g16)
    (part-of pos-3-8 g16)
    (part-of pos-6-9 g17)
    (part-of pos-5-10 g17)
    (part-of pos-5-8 g17)
    (part-of pos-11-11 g18)
    (part-of pos-10-10 g18)
    (part-of pos-11-9 g18)
    (part-of pos-13-11 g19)
    (part-of pos-13-9 g19)
    (part-of pos-7-11 g20)
    (part-of pos-6-12 g20)
    (part-of pos-5-11 g20)
    (part-of pos-6-10 g20)
    (part-of pos-9-12 g21)
    (part-of pos-8-13 g21)
    (part-of pos-7-12 g21)
    (part-of pos-8-11 g21)
    (part-of pos-13-13 g22)
    (part-of pos-11-13 g22)
    (part-of pos-12-12 g22)
    (remaining-cells g0 n10)
    ...
    (remaining-cells g10 n3)
    (remaining-cells g11 n9)
    (remaining-cells g12 n6)
    (remaining-cells g13 n1)
    (remaining-cells g14 n1)
    (remaining-cells g15 n5)
    (remaining-cells g16 n7)
    (remaining-cells g17 n1)
    (remaining-cells g18 n2)
