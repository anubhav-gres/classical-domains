(define (problem random-12x12-1062)
(:domain nurikabe)
(:objects
...
(:init
    ...
    (part-of pos-0-8 g10)
    (part-of pos-1-7 g10)
    (part-of pos-11-9 g11)
    (part-of pos-10-10 g11)
    (part-of pos-9-9 g11)
    (part-of pos-10-8 g11)
    (part-of pos-1-10 g12)
    (part-of pos-0-11 g12)
    (part-of pos-0-9 g12)
    (part-of pos-3-11 g13)
    (part-of pos-1-11 g13)
    (part-of pos-2-10 g13)
    (remaining-cells g0 n9)
    (remaining-cells g1 n2)
    (remaining-cells g2 n10)
    (remaining-cells g3 n1)
    (remaining-cells g4 n2)
    (remaining-cells g5 n3)
    (remaining-cells g6 n8)
    (remaining-cells g7 n11)
    (remaining-cells g8 n6)
    (remaining-cells g9 n2)
    (remaining-cells g10 n2)
    (remaining-cells g11 n4)
