(define (problem random-13x13-6230)
(:domain nurikabe)
(:objects
    ...
    g0 g1 g2 g3 g4 g5 g6 g7 g8 g9 g10 g11 g12 g13 g14 g15 g16 g17 g18 g19 - group
)
(:init
    (next n0 n1)
    (next n1 n2)
    ...
    (part-of pos-6-8 g13)
    (part-of pos-7-7 g13)
    (part-of pos-12-8 g14)
    (part-of pos-11-7 g14)
    (part-of pos-6-9 g15)
    (part-of pos-5-10 g15)
    (part-of pos-4-9 g15)
    (part-of pos-5-8 g15)
    (part-of pos-10-10 g16)
    (part-of pos-9-9 g16)
    (part-of pos-4-10 g17)
    (part-of pos-3-11 g17)
    (part-of pos-2-10 g17)
    (part-of pos-3-9 g17)
    (part-of pos-2-12 g18)
    (part-of pos-0-12 g18)
    (part-of pos-1-11 g18)
    (part-of pos-7-12 g19)
    (part-of pos-5-12 g19)
    (part-of pos-6-11 g19)
    (remaining-cells g0 n3)
    (remaining-cells g1 n9)
    (remaining-cells g2 n1)
    (remaining-cells g3 n11)
    (remaining-cells g4 n2)
    (remaining-cells g5 n5)
    (remaining-cells g6 n5)
    (remaining-cells g7 n1)
    (remaining-cells g8 n2)
    (remaining-cells g9 n5)
    (remaining-cells g10 n3)
    (remaining-cells g11 n2)
    (remaining-cells g12 n5)
    (remaining-cells g13 n6)
    (remaining-cells g14 n1)
    (remaining-cells g15 n2)
