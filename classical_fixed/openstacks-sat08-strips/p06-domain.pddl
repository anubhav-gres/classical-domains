...
:parameters ()
:precondition (and (not-made p4)(started o4)(started o8))
...
:parameters ()
:precondition (and (not-made p6)(started o1)(started o5)(started o7)(started o10))
...
:parameters ()
:precondition (and (not-made p9)(started o6)(started o7))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o2)(made p2)(made p3)(stacks-avail ?avail)(next-count ?avail ?new-avail))
:effect (and (not (started o2))(shipped o2)(not (stacks-avail ?avail))(stacks-avail ?new-avail)))

(:action ship-order-o3
:parameters (?avail ?new-avail - count)
:precondition (and (started o3)(made p10)(stacks-avail ?avail)(next-count ?avail ?new-avail))
:effect (and (not (started o3))(shipped o3)(not (stacks-avail ?avail))(stacks-avail ?new-avail)))

(:action ship-order-o4
:parameters (?avail ?new-avail - count)
:precondition (and (started o4)(made p4)(made p8)(stacks-avail ?avail)(next-count ?avail ?new-avail))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o7)(made p5)(made p6)(made p9)(stacks-avail ?avail)(next-count ?avail ?new-avail))
:effect (and (not (started o7))(shipped o7)(not (stacks-avail ?avail))(stacks-avail ?new-avail)))

(:action ship-order-o8
:parameters (?avail ?new-avail - count)
:precondition (and (started o8)(made p1)(made p4)(stacks-avail ?avail)(next-count ?avail ?new-avail))
