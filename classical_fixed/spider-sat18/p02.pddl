(define (problem spider-1-4-8-6-2-3501)
(:domain spider)
; using 1 decks of cards with 4 suits per deck and 8 values per suit
;
; deals
; deal 0: d0-s1-v0 d0-s3-v1 d0-s2-v5 d0-s0-v3 d0-s0-v1 d0-s2-v6
; deal 1: d0-s3-v5 d0-s1-v6 d0-s2-v1 d0-s1-v4 d0-s3-v0 d0-s0-v4
;
; initial configuration of piles
; pile 0: d0-s3-v3 d0-s1-v5 d0-s2-v3 d0-s0-v5
; pile 1: d0-s3-v6 d0-s0-v2 d0-s1-v7 d0-s0-v6
; pile 2: d0-s0-v0 d0-s2-v4 d0-s1-v3
; pile 3: d0-s1-v2 d0-s3-v7 d0-s2-v2
; pile 4: d0-s3-v2 d0-s2-v0 d0-s0-v7
; pile 5: d0-s2-v7 d0-s3-v4 d0-s1-v1
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    ...
    (on card-d0-s2-v3 card-d0-s1-v5)
    (on card-d0-s0-v5 card-d0-s2-v3)
    ...
    (on card-d0-s0-v2 card-d0-s3-v6)
    (on card-d0-s1-v7 card-d0-s0-v2)
    (on card-d0-s0-v6 card-d0-s1-v7)
    (on card-d0-s3-v6 pile-1)
    (clear card-d0-s0-v6)
    (part-of-tableau pile-1 pile-1)
    (part-of-tableau card-d0-s3-v6 pile-1)
    ...
    (on card-d0-s2-v4 card-d0-s0-v0)
    (on card-d0-s1-v3 card-d0-s2-v4)
    ...
    (on card-d0-s3-v7 card-d0-s1-v2)
    (on card-d0-s2-v2 card-d0-s3-v7)
    (on card-d0-s1-v2 pile-3)
    (clear card-d0-s2-v2)
    (part-of-tableau pile-3 pile-3)
    (part-of-tableau card-d0-s1-v2 pile-3)
    (part-of-tableau card-d0-s3-v7 pile-3)
    (part-of-tableau card-d0-s2-v2 pile-3)
    (movable card-d0-s2-v2)
    (in-play card-d0-s1-v2)
    (in-play card-d0-s3-v7)
    (in-play card-d0-s2-v2)
    (on card-d0-s2-v0 card-d0-s3-v2)
    (on card-d0-s0-v7 card-d0-s2-v0)
    (on card-d0-s3-v2 pile-4)
    (clear card-d0-s0-v7)
    (part-of-tableau pile-4 pile-4)
    (part-of-tableau card-d0-s3-v2 pile-4)
    (part-of-tableau card-d0-s2-v0 pile-4)
    (part-of-tableau card-d0-s0-v7 pile-4)
    (movable card-d0-s0-v7)
    (in-play card-d0-s3-v2)
    (in-play card-d0-s2-v0)
    (in-play card-d0-s0-v7)
    (on card-d0-s3-v4 card-d0-s2-v7)
    (on card-d0-s1-v1 card-d0-s3-v4)
    (on card-d0-s2-v7 pile-5)
    (clear card-d0-s1-v1)
    (part-of-tableau pile-5 pile-5)
    (part-of-tableau card-d0-s2-v7 pile-5)
    ...
    (on card-d0-s3-v1 card-d0-s1-v0)
    (on card-d0-s2-v5 card-d0-s3-v1)
    (on card-d0-s0-v3 card-d0-s2-v5)
    (on card-d0-s0-v1 card-d0-s0-v3)
    (on card-d0-s2-v6 card-d0-s0-v1)
    (clear card-d0-s2-v6)
    (on card-d0-s3-v5 deal-1)
    (on card-d0-s1-v6 card-d0-s3-v5)
    (on card-d0-s2-v1 card-d0-s1-v6)
    (on card-d0-s1-v4 card-d0-s2-v1)
    (on card-d0-s3-v0 card-d0-s1-v4)
    (on card-d0-s0-v4 card-d0-s3-v0)
    (clear card-d0-s0-v4)
    (current-deal deal-0)
    ...
    (to-deal card-d0-s1-v0 pile-5 deal-0 deal-0)
    (to-deal card-d0-s2-v6 pile-0 deal-0 card-d0-s0-v1)
    (to-deal card-d0-s0-v1 pile-1 deal-0 card-d0-s0-v3)
    (to-deal card-d0-s0-v3 pile-2 deal-0 card-d0-s2-v5)
    (to-deal card-d0-s2-v5 pile-3 deal-0 card-d0-s3-v1)
    (to-deal card-d0-s3-v1 pile-4 deal-0 card-d0-s1-v0)
    (to-deal card-d0-s3-v5 pile-5 deal-1 deal-1)
    (to-deal card-d0-s0-v4 pile-0 deal-1 card-d0-s3-v0)
    (to-deal card-d0-s3-v0 pile-1 deal-1 card-d0-s1-v4)
    (to-deal card-d0-s1-v4 pile-2 deal-1 card-d0-s2-v1)
    (to-deal card-d0-s2-v1 pile-3 deal-1 card-d0-s1-v6)
    (to-deal card-d0-s1-v6 pile-4 deal-1 card-d0-s3-v5)
    (= (total-cost) 0)
)
(:goal
(and
