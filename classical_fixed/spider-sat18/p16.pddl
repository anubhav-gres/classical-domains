(define (problem spider-4-1-8-6-2-2200)
(:domain spider)
; using 4 decks of cards with 1 suits per deck and 8 values per suit
;
; deals
; deal 0: d2-s0-v4 d3-s0-v1 d2-s0-v5 d2-s0-v3 d0-s0-v1 d0-s0-v4
; deal 1: d1-s0-v4 d1-s0-v7 d2-s0-v0 d0-s0-v5 d3-s0-v3 d3-s0-v5
;
; initial configuration of piles
; pile 0: d0-s0-v0 d3-s0-v6 d0-s0-v2 d2-s0-v7
; pile 1: d1-s0-v5 d1-s0-v1 d2-s0-v2 d1-s0-v2
; pile 2: d3-s0-v2 d0-s0-v7 d3-s0-v7
; pile 3: d3-s0-v4 d3-s0-v0 d2-s0-v1
; pile 4: d0-s0-v3 d1-s0-v0 d0-s0-v6
; pile 5: d2-s0-v6 d1-s0-v6 d1-s0-v3
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    (on card-d3-s0-v6 card-d0-s0-v0)
    (on card-d0-s0-v2 card-d3-s0-v6)
    (on card-d2-s0-v7 card-d0-s0-v2)
    ...
    (on card-d0-s0-v7 card-d3-s0-v2)
    (on card-d3-s0-v7 card-d0-s0-v7)
    (on card-d3-s0-v2 pile-2)
    (clear card-d3-s0-v7)
    ...
    (on card-d3-s0-v0 card-d3-s0-v4)
    ...
    (on card-d1-s0-v0 card-d0-s0-v3)
    ...
    (on card-d1-s0-v6 card-d2-s0-v6)
    (on card-d1-s0-v3 card-d1-s0-v6)
    (on card-d2-s0-v6 pile-5)
    (clear card-d1-s0-v3)
    (part-of-tableau pile-5 pile-5)
    (part-of-tableau card-d2-s0-v6 pile-5)
    (part-of-tableau card-d1-s0-v6 pile-5)
    (part-of-tableau card-d1-s0-v3 pile-5)
    (movable card-d1-s0-v3)
    (in-play card-d2-s0-v6)
    (in-play card-d1-s0-v6)
    (in-play card-d1-s0-v3)
    (on card-d2-s0-v4 deal-0)
    (on card-d3-s0-v1 card-d2-s0-v4)
    (on card-d2-s0-v5 card-d3-s0-v1)
    (on card-d2-s0-v3 card-d2-s0-v5)
    (on card-d0-s0-v1 card-d2-s0-v3)
    (on card-d0-s0-v4 card-d0-s0-v1)
    (clear card-d0-s0-v4)
    (on card-d1-s0-v4 deal-1)
    (on card-d1-s0-v7 card-d1-s0-v4)
    (on card-d2-s0-v0 card-d1-s0-v7)
    (on card-d0-s0-v5 card-d2-s0-v0)
    (on card-d3-s0-v3 card-d0-s0-v5)
    (on card-d3-s0-v5 card-d3-s0-v3)
    (clear card-d3-s0-v5)
    (current-deal deal-0)
    ...
    (to-deal card-d2-s0-v4 pile-5 deal-0 deal-0)
    (to-deal card-d0-s0-v4 pile-0 deal-0 card-d0-s0-v1)
    (to-deal card-d0-s0-v1 pile-1 deal-0 card-d2-s0-v3)
    (to-deal card-d2-s0-v3 pile-2 deal-0 card-d2-s0-v5)
    (to-deal card-d2-s0-v5 pile-3 deal-0 card-d3-s0-v1)
    (to-deal card-d3-s0-v1 pile-4 deal-0 card-d2-s0-v4)
    (to-deal card-d1-s0-v4 pile-5 deal-1 deal-1)
    (to-deal card-d3-s0-v5 pile-0 deal-1 card-d3-s0-v3)
    (to-deal card-d3-s0-v3 pile-1 deal-1 card-d0-s0-v5)
    (to-deal card-d0-s0-v5 pile-2 deal-1 card-d2-s0-v0)
    (to-deal card-d2-s0-v0 pile-3 deal-1 card-d1-s0-v7)
    (to-deal card-d1-s0-v7 pile-4 deal-1 card-d1-s0-v4)
    (= (total-cost) 0)
)
(:goal
(and
