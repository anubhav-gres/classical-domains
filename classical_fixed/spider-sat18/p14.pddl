(define (problem spider-4-1-6-4-2-2000)
(:domain spider)
; using 4 decks of cards with 1 suits per deck and 6 values per suit
;
; deals
; deal 0: d0-s0-v0 d3-s0-v0 d1-s0-v2 d0-s0-v3
; deal 1: d3-s0-v2 d0-s0-v5 d1-s0-v1 d2-s0-v0
;
; initial configuration of piles
; pile 0: d1-s0-v5 d1-s0-v0 d0-s0-v1 d3-s0-v1
; pile 1: d2-s0-v2 d3-s0-v4 d0-s0-v2 d1-s0-v3
; pile 2: d2-s0-v1 d0-s0-v4 d2-s0-v5 d2-s0-v3
; pile 3: d2-s0-v4 d3-s0-v5 d3-s0-v3 d1-s0-v4
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    (on card-d1-s0-v0 card-d1-s0-v5)
    (on card-d0-s0-v1 card-d1-s0-v0)
    (on card-d3-s0-v1 card-d0-s0-v1)
    (on card-d1-s0-v5 pile-0)
    (clear card-d3-s0-v1)
    (part-of-tableau pile-0 pile-0)
    (part-of-tableau card-d1-s0-v5 pile-0)
    ...
    (on card-d3-s0-v5 card-d2-s0-v4)
    (on card-d3-s0-v3 card-d3-s0-v5)
    (on card-d1-s0-v4 card-d3-s0-v3)
    (on card-d2-s0-v4 pile-3)
    (clear card-d1-s0-v4)
    (part-of-tableau pile-3 pile-3)
    (part-of-tableau card-d2-s0-v4 pile-3)
    (part-of-tableau card-d3-s0-v5 pile-3)
    (part-of-tableau card-d3-s0-v3 pile-3)
    (part-of-tableau card-d1-s0-v4 pile-3)
    ...
    (on card-d3-s0-v0 card-d0-s0-v0)
    (on card-d1-s0-v2 card-d3-s0-v0)
    (on card-d0-s0-v3 card-d1-s0-v2)
    (clear card-d0-s0-v3)
    (on card-d3-s0-v2 deal-1)
    (on card-d0-s0-v5 card-d3-s0-v2)
    (on card-d1-s0-v1 card-d0-s0-v5)
    (on card-d2-s0-v0 card-d1-s0-v1)
    (clear card-d2-s0-v0)
    (current-deal deal-0)
    ...
    (to-deal card-d0-s0-v0 pile-3 deal-0 deal-0)
    (to-deal card-d0-s0-v3 pile-0 deal-0 card-d1-s0-v2)
    (to-deal card-d1-s0-v2 pile-1 deal-0 card-d3-s0-v0)
    (to-deal card-d3-s0-v0 pile-2 deal-0 card-d0-s0-v0)
    (to-deal card-d3-s0-v2 pile-3 deal-1 deal-1)
    (to-deal card-d2-s0-v0 pile-0 deal-1 card-d1-s0-v1)
    (to-deal card-d1-s0-v1 pile-1 deal-1 card-d0-s0-v5)
    (to-deal card-d0-s0-v5 pile-2 deal-1 card-d3-s0-v2)
    (= (total-cost) 0)
)
(:goal
(and
