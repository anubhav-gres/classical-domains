...
(:init
    ...
    (part-of-tableau card-d0-s1-v3 pile-1)
    (part-of-tableau card-d0-s3-v4 pile-1)
    (movable card-d0-s3-v4)
    ...
    (part-of-tableau card-d0-s3-v6 pile-2)
    (part-of-tableau card-d0-s0-v8 pile-2)
    (movable card-d0-s0-v8)
    ...
    (part-of-tableau card-d0-s3-v2 pile-3)
    ...
    (part-of-tableau card-d0-s1-v7 pile-5)
    (part-of-tableau card-d0-s0-v1 pile-5)
    (part-of-tableau card-d0-s0-v5 pile-5)
