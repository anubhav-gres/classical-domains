(define (problem spider-1-4-10-7-2-3700)
(:domain spider)
; using 1 decks of cards with 4 suits per deck and 10 values per suit
;
; deals
; deal 0: d0-s2-v8 d0-s2-v6 d0-s3-v6 d0-s1-v4 d0-s1-v9 d0-s2-v3 d0-s2-v1
; deal 1: d0-s3-v8 d0-s0-v6 d0-s1-v6 d0-s0-v5 d0-s0-v4 d0-s1-v0 d0-s0-v0
;
; initial configuration of piles
; pile 0: d0-s1-v7 d0-s0-v8 d0-s3-v7 d0-s3-v1
; pile 1: d0-s3-v4 d0-s3-v9 d0-s1-v1 d0-s0-v7
; pile 2: d0-s1-v3 d0-s3-v5 d0-s0-v9 d0-s2-v2
; pile 3: d0-s2-v7 d0-s2-v5 d0-s2-v0 d0-s3-v3
; pile 4: d0-s1-v5 d0-s0-v2 d0-s1-v8 d0-s3-v0
; pile 5: d0-s2-v4 d0-s0-v3 d0-s0-v1
; pile 6: d0-s2-v9 d0-s1-v2 d0-s3-v2
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    (on card-d0-s0-v8 card-d0-s1-v7)
    (on card-d0-s3-v7 card-d0-s0-v8)
    (on card-d0-s3-v1 card-d0-s3-v7)
    (on card-d0-s1-v7 pile-0)
    (clear card-d0-s3-v1)
    (part-of-tableau pile-0 pile-0)
    (part-of-tableau card-d0-s1-v7 pile-0)
    (part-of-tableau card-d0-s0-v8 pile-0)
    ...
    (on card-d0-s3-v9 card-d0-s3-v4)
    (on card-d0-s1-v1 card-d0-s3-v9)
    (on card-d0-s0-v7 card-d0-s1-v1)
    (on card-d0-s3-v4 pile-1)
    (clear card-d0-s0-v7)
    (part-of-tableau pile-1 pile-1)
    (part-of-tableau card-d0-s3-v4 pile-1)
    (part-of-tableau card-d0-s3-v9 pile-1)
    ...
    (on card-d0-s3-v5 card-d0-s1-v3)
    (on card-d0-s0-v9 card-d0-s3-v5)
    (on card-d0-s2-v2 card-d0-s0-v9)
    (on card-d0-s1-v3 pile-2)
    (clear card-d0-s2-v2)
    (part-of-tableau pile-2 pile-2)
    (part-of-tableau card-d0-s1-v3 pile-2)
    (part-of-tableau card-d0-s3-v5 pile-2)
    (part-of-tableau card-d0-s0-v9 pile-2)
    ...
    (on card-d0-s2-v0 card-d0-s2-v5)
    (on card-d0-s3-v3 card-d0-s2-v0)
    (on card-d0-s2-v7 pile-3)
    (clear card-d0-s3-v3)
    (part-of-tableau pile-3 pile-3)
    (part-of-tableau card-d0-s2-v7 pile-3)
    (part-of-tableau card-d0-s2-v5 pile-3)
    ...
    (on card-d0-s0-v2 card-d0-s1-v5)
    (on card-d0-s1-v8 card-d0-s0-v2)
    (on card-d0-s3-v0 card-d0-s1-v8)
    (on card-d0-s1-v5 pile-4)
    (clear card-d0-s3-v0)
    (part-of-tableau pile-4 pile-4)
    (part-of-tableau card-d0-s1-v5 pile-4)
    (part-of-tableau card-d0-s0-v2 pile-4)
    (part-of-tableau card-d0-s1-v8 pile-4)
    (part-of-tableau card-d0-s3-v0 pile-4)
    (movable card-d0-s3-v0)
    (in-play card-d0-s1-v5)
    (in-play card-d0-s0-v2)
    (in-play card-d0-s1-v8)
    (in-play card-d0-s3-v0)
    (on card-d0-s0-v3 card-d0-s2-v4)
    (on card-d0-s0-v1 card-d0-s0-v3)
    (on card-d0-s2-v4 pile-5)
    (clear card-d0-s0-v1)
    (part-of-tableau pile-5 pile-5)
    (part-of-tableau card-d0-s2-v4 pile-5)
    (part-of-tableau card-d0-s0-v3 pile-5)
    (part-of-tableau card-d0-s0-v1 pile-5)
    (movable card-d0-s0-v1)
    (in-play card-d0-s2-v4)
    (in-play card-d0-s0-v3)
    (in-play card-d0-s0-v1)
    (on card-d0-s1-v2 card-d0-s2-v9)
    (on card-d0-s3-v2 card-d0-s1-v2)
    (on card-d0-s2-v9 pile-6)
    (clear card-d0-s3-v2)
    (part-of-tableau pile-6 pile-6)
    (part-of-tableau card-d0-s2-v9 pile-6)
    (part-of-tableau card-d0-s1-v2 pile-6)
    (part-of-tableau card-d0-s3-v2 pile-6)
    ...
    (on card-d0-s3-v6 card-d0-s2-v6)
    (on card-d0-s1-v4 card-d0-s3-v6)
    (on card-d0-s1-v9 card-d0-s1-v4)
    (on card-d0-s2-v3 card-d0-s1-v9)
    (on card-d0-s2-v1 card-d0-s2-v3)
    (clear card-d0-s2-v1)
    (on card-d0-s3-v8 deal-1)
    (on card-d0-s0-v6 card-d0-s3-v8)
    (on card-d0-s1-v6 card-d0-s0-v6)
    (on card-d0-s0-v5 card-d0-s1-v6)
    (on card-d0-s0-v4 card-d0-s0-v5)
    (on card-d0-s1-v0 card-d0-s0-v4)
    ...
    (is-king card-d0-s2-v9)
    (is-king card-d0-s3-v9)
    (next-deal deal-0 deal-1)
    (next-deal deal-1 deal-2)
    (to-deal card-d0-s2-v8 pile-6 deal-0 deal-0)
    (to-deal card-d0-s2-v1 pile-0 deal-0 card-d0-s2-v3)
    (to-deal card-d0-s2-v3 pile-1 deal-0 card-d0-s1-v9)
    (to-deal card-d0-s1-v9 pile-2 deal-0 card-d0-s1-v4)
    (to-deal card-d0-s1-v4 pile-3 deal-0 card-d0-s3-v6)
    (to-deal card-d0-s3-v6 pile-4 deal-0 card-d0-s2-v6)
    (to-deal card-d0-s2-v6 pile-5 deal-0 card-d0-s2-v8)
    (to-deal card-d0-s3-v8 pile-6 deal-1 deal-1)
    (to-deal card-d0-s0-v0 pile-0 deal-1 card-d0-s1-v0)
    (to-deal card-d0-s1-v0 pile-1 deal-1 card-d0-s0-v4)
    (to-deal card-d0-s0-v4 pile-2 deal-1 card-d0-s0-v5)
    (to-deal card-d0-s0-v5 pile-3 deal-1 card-d0-s1-v6)
    (to-deal card-d0-s1-v6 pile-4 deal-1 card-d0-s0-v6)
    (to-deal card-d0-s0-v6 pile-5 deal-1 card-d0-s3-v8)
    (= (total-cost) 0)
)
(:goal
(and
