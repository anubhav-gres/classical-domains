(define (problem spider-2-2-10-7-2-3100)
(:domain spider)
; using 2 decks of cards with 2 suits per deck and 10 values per suit
;
; deals
; deal 0: d0-s1-v4 d1-s0-v3 d0-s0-v2 d0-s0-v8 d1-s0-v4 d1-s0-v9 d1-s1-v8
; deal 1: d1-s0-v1 d0-s0-v9 d1-s1-v7 d0-s0-v7 d1-s0-v7 d0-s0-v4 d1-s0-v5
;
; initial configuration of piles
; pile 0: d1-s1-v5 d1-s0-v0 d0-s1-v5 d1-s1-v2
; pile 1: d0-s0-v5 d1-s1-v9 d1-s1-v0 d0-s1-v8
; pile 2: d0-s0-v0 d0-s1-v3 d1-s1-v4 d0-s0-v6
; pile 3: d0-s0-v3 d1-s1-v3 d0-s1-v1 d1-s1-v1
; pile 4: d1-s0-v8 d0-s1-v2 d0-s1-v7 d0-s1-v9
; pile 5: d1-s0-v6 d1-s1-v6 d0-s1-v6
; pile 6: d0-s0-v1 d0-s1-v0 d1-s0-v2
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    (on card-d1-s0-v0 card-d1-s1-v5)
    (on card-d0-s1-v5 card-d1-s0-v0)
    (on card-d1-s1-v2 card-d0-s1-v5)
    ...
    (part-of-tableau card-d1-s1-v4 pile-2)
    ...
    (on card-d1-s1-v3 card-d0-s0-v3)
    (on card-d0-s1-v1 card-d1-s1-v3)
    (on card-d1-s1-v1 card-d0-s1-v1)
    ...
    (movable card-d1-s1-v1)
    (in-play card-d0-s0-v3)
    (in-play card-d1-s1-v3)
    (in-play card-d0-s1-v1)
    (in-play card-d1-s1-v1)
    (on card-d0-s1-v2 card-d1-s0-v8)
    (on card-d0-s1-v7 card-d0-s1-v2)
    (on card-d0-s1-v9 card-d0-s1-v7)
    (on card-d1-s0-v8 pile-4)
    (clear card-d0-s1-v9)
    (part-of-tableau pile-4 pile-4)
    (part-of-tableau card-d1-s0-v8 pile-4)
    (part-of-tableau card-d0-s1-v2 pile-4)
    (part-of-tableau card-d0-s1-v7 pile-4)
    (part-of-tableau card-d0-s1-v9 pile-4)
    (movable card-d0-s1-v9)
    (in-play card-d1-s0-v8)
    (in-play card-d0-s1-v2)
    (in-play card-d0-s1-v7)
    (in-play card-d0-s1-v9)
    (on card-d1-s1-v6 card-d1-s0-v6)
    (on card-d0-s1-v6 card-d1-s1-v6)
    (on card-d1-s0-v6 pile-5)
    (clear card-d0-s1-v6)
    (part-of-tableau pile-5 pile-5)
    (part-of-tableau card-d1-s0-v6 pile-5)
    (part-of-tableau card-d1-s1-v6 pile-5)
    (part-of-tableau card-d0-s1-v6 pile-5)
    (movable card-d0-s1-v6)
    (in-play card-d1-s0-v6)
    (in-play card-d1-s1-v6)
    (in-play card-d0-s1-v6)
    (on card-d0-s1-v0 card-d0-s0-v1)
    (on card-d1-s0-v2 card-d0-s1-v0)
    (on card-d0-s0-v1 pile-6)
    (clear card-d1-s0-v2)
    (part-of-tableau pile-6 pile-6)
    (part-of-tableau card-d0-s0-v1 pile-6)
    (part-of-tableau card-d0-s1-v0 pile-6)
    (part-of-tableau card-d1-s0-v2 pile-6)
    (movable card-d1-s0-v2)
    (in-play card-d0-s0-v1)
    (in-play card-d0-s1-v0)
    (in-play card-d1-s0-v2)
    (on card-d0-s1-v4 deal-0)
    (on card-d1-s0-v3 card-d0-s1-v4)
    (on card-d0-s0-v2 card-d1-s0-v3)
    (on card-d0-s0-v8 card-d0-s0-v2)
    (on card-d1-s0-v4 card-d0-s0-v8)
    (on card-d1-s0-v9 card-d1-s0-v4)
    (on card-d1-s1-v8 card-d1-s0-v9)
    (clear card-d1-s1-v8)
    (on card-d1-s0-v1 deal-1)
    (on card-d0-s0-v9 card-d1-s0-v1)
    (on card-d1-s1-v7 card-d0-s0-v9)
    (on card-d0-s0-v7 card-d1-s1-v7)
    (on card-d1-s0-v7 card-d0-s0-v7)
    (on card-d0-s0-v4 card-d1-s0-v7)
    ...
    (to-deal card-d0-s1-v4 pile-6 deal-0 deal-0)
    (to-deal card-d1-s1-v8 pile-0 deal-0 card-d1-s0-v9)
    (to-deal card-d1-s0-v9 pile-1 deal-0 card-d1-s0-v4)
    (to-deal card-d1-s0-v4 pile-2 deal-0 card-d0-s0-v8)
    (to-deal card-d0-s0-v8 pile-3 deal-0 card-d0-s0-v2)
    (to-deal card-d0-s0-v2 pile-4 deal-0 card-d1-s0-v3)
    (to-deal card-d1-s0-v3 pile-5 deal-0 card-d0-s1-v4)
    (to-deal card-d1-s0-v1 pile-6 deal-1 deal-1)
    (to-deal card-d1-s0-v5 pile-0 deal-1 card-d0-s0-v4)
    (to-deal card-d0-s0-v4 pile-1 deal-1 card-d1-s0-v7)
    (to-deal card-d1-s0-v7 pile-2 deal-1 card-d0-s0-v7)
    (to-deal card-d0-s0-v7 pile-3 deal-1 card-d1-s1-v7)
    (to-deal card-d1-s1-v7 pile-4 deal-1 card-d0-s0-v9)
    (to-deal card-d0-s0-v9 pile-5 deal-1 card-d1-s0-v1)
    (= (total-cost) 0)
)
(:goal
(and
