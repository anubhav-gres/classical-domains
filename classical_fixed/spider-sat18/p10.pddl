(define (problem spider-2-2-9-6-2-3000)
(:domain spider)
; using 2 decks of cards with 2 suits per deck and 9 values per suit
;
; deals
; deal 0: d1-s1-v7 d1-s1-v4 d1-s1-v8 d1-s1-v1 d0-s1-v3 d1-s1-v5
; deal 1: d0-s0-v0 d0-s0-v1 d0-s1-v2 d1-s0-v6 d1-s1-v0 d1-s0-v5
;
; initial configuration of piles
; pile 0: d0-s0-v2 d1-s0-v1 d1-s0-v0 d0-s0-v3
; pile 1: d0-s1-v7 d1-s1-v6 d0-s1-v5 d1-s0-v7
; pile 2: d0-s0-v8 d1-s1-v2 d0-s0-v7 d0-s1-v8
; pile 3: d1-s1-v3 d1-s0-v8 d0-s0-v5 d0-s1-v6
; pile 4: d0-s0-v6 d0-s1-v4 d1-s0-v2 d0-s0-v4
; pile 5: d1-s0-v3 d0-s1-v0 d0-s1-v1 d1-s0-v4
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    ...
    (on card-d0-s0-v3 card-d1-s0-v0)
    ...
    (on card-d1-s1-v6 card-d0-s1-v7)
    (on card-d0-s1-v5 card-d1-s1-v6)
    (on card-d1-s0-v7 card-d0-s1-v5)
    (on card-d0-s1-v7 pile-1)
    (clear card-d1-s0-v7)
    (part-of-tableau pile-1 pile-1)
    (part-of-tableau card-d0-s1-v7 pile-1)
    (part-of-tableau card-d1-s1-v6 pile-1)
    (part-of-tableau card-d0-s1-v5 pile-1)
    ...
    (on card-d1-s0-v2 card-d0-s1-v4)
    (on card-d0-s0-v4 card-d1-s0-v2)
    (on card-d0-s0-v6 pile-4)
    (clear card-d0-s0-v4)
    ...
    (on card-d0-s1-v0 card-d1-s0-v3)
    (on card-d0-s1-v1 card-d0-s1-v0)
    (on card-d1-s0-v4 card-d0-s1-v1)
    (on card-d1-s0-v3 pile-5)
    (clear card-d1-s0-v4)
    ...
    (on card-d1-s1-v7 deal-0)
    (on card-d1-s1-v4 card-d1-s1-v7)
    (on card-d1-s1-v8 card-d1-s1-v4)
    (on card-d1-s1-v1 card-d1-s1-v8)
    (on card-d0-s1-v3 card-d1-s1-v1)
    (on card-d1-s1-v5 card-d0-s1-v3)
    (clear card-d1-s1-v5)
    (on card-d0-s0-v0 deal-1)
    (on card-d0-s0-v1 card-d0-s0-v0)
    (on card-d0-s1-v2 card-d0-s0-v1)
    (on card-d1-s0-v6 card-d0-s1-v2)
    ...
    (to-deal card-d1-s1-v7 pile-5 deal-0 deal-0)
    (to-deal card-d1-s1-v5 pile-0 deal-0 card-d0-s1-v3)
    (to-deal card-d0-s1-v3 pile-1 deal-0 card-d1-s1-v1)
    (to-deal card-d1-s1-v1 pile-2 deal-0 card-d1-s1-v8)
    (to-deal card-d1-s1-v8 pile-3 deal-0 card-d1-s1-v4)
    (to-deal card-d1-s1-v4 pile-4 deal-0 card-d1-s1-v7)
    (to-deal card-d0-s0-v0 pile-5 deal-1 deal-1)
    (to-deal card-d1-s0-v5 pile-0 deal-1 card-d1-s1-v0)
    (to-deal card-d1-s1-v0 pile-1 deal-1 card-d1-s0-v6)
    (to-deal card-d1-s0-v6 pile-2 deal-1 card-d0-s1-v2)
    (to-deal card-d0-s1-v2 pile-3 deal-1 card-d0-s0-v1)
    (to-deal card-d0-s0-v1 pile-4 deal-1 card-d0-s0-v0)
    (= (total-cost) 0)
)
(:goal
(and
