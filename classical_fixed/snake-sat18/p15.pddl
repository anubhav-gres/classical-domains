(define (problem snake-empty-8x8-1-5-57-223100)
(:domain snake)
(:objects
...
(:init
    ...
    (nextspawn pos0-1 pos5-3)
    (nextspawn pos5-3 pos0-2)
    (nextspawn pos0-2 pos2-7)
    (nextspawn pos2-7 pos2-5)
    (nextspawn pos2-5 pos1-3)
    (nextspawn pos1-3 pos2-1)
    (nextspawn pos2-1 pos6-4)
    (nextspawn pos6-4 pos1-7)
    (nextspawn pos1-7 pos7-5)
    (nextspawn pos7-5 pos4-3)
    (nextspawn pos4-3 pos1-4)
    (nextspawn pos1-4 pos4-4)
    (nextspawn pos4-4 pos4-0)
    (nextspawn pos4-0 pos5-2)
    (nextspawn pos5-2 pos2-3)
    (nextspawn pos2-3 pos6-5)
    (nextspawn pos6-5 pos0-5)
    (nextspawn pos0-5 pos3-2)
    (nextspawn pos3-2 pos3-1)
    (nextspawn pos3-1 pos7-3)
    (nextspawn pos7-3 pos2-2)
    (nextspawn pos2-2 pos2-6)
    (nextspawn pos2-6 pos0-7)
    (nextspawn pos0-7 pos6-3)
    (nextspawn pos6-3 pos5-0)
    (nextspawn pos5-0 pos5-4)
    (nextspawn pos5-4 pos7-2)
    (nextspawn pos7-2 pos4-5)
    (nextspawn pos4-5 pos0-0)
    (nextspawn pos0-0 pos2-0)
    (nextspawn pos2-0 pos3-3)
    (nextspawn pos3-3 pos3-5)
    (nextspawn pos3-5 pos0-3)
    (nextspawn pos0-3 pos6-6)
    (nextspawn pos6-6 pos3-4)
    (nextspawn pos3-4 pos1-5)
    (nextspawn pos1-5 pos5-7)
    (nextspawn pos5-7 pos1-6)
    (nextspawn pos1-6 pos6-1)
    (nextspawn pos6-1 pos7-6)
    (nextspawn pos7-6 pos6-7)
    (nextspawn pos6-7 pos1-1)
    (nextspawn pos1-1 pos7-0)
    (nextspawn pos7-0 pos5-5)
    (nextspawn pos5-5 pos1-0)
    (nextspawn pos1-0 pos4-2)
    (nextspawn pos4-2 pos4-6)
    (nextspawn pos4-6 pos6-0)
    (nextspawn pos6-0 pos1-2)
    (nextspawn pos1-2 pos7-4)
    (nextspawn pos7-4 pos0-6)
    (nextspawn pos0-6 pos6-2)
    (nextspawn pos6-2 pos7-1)
    (nextspawn pos7-1 pos2-4)
    (ispoint pos0-4)
    (ispoint pos3-0)
    (ispoint pos7-7)
    (ispoint pos4-1)
