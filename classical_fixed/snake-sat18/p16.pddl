(define (problem snake-empty-9x9-1-5-25-22440)
(:domain snake)
(:objects
...
(:init
    ...
    (nextspawn pos8-5 pos6-5)
    (nextspawn pos6-5 pos1-3)
    (nextspawn pos1-3 pos3-1)
    (nextspawn pos3-1 pos6-4)
    (nextspawn pos6-4 pos7-2)
    (nextspawn pos7-2 pos5-4)
    (nextspawn pos5-4 pos6-3)
    (nextspawn pos6-3 pos0-1)
    (nextspawn pos0-1 pos2-0)
    (nextspawn pos2-0 pos8-6)
    (nextspawn pos8-6 pos7-5)
    (nextspawn pos7-5 pos4-1)
    (nextspawn pos4-1 pos1-8)
    (nextspawn pos1-8 pos2-5)
    (nextspawn pos2-5 pos4-2)
    (nextspawn pos4-2 pos4-5)
    (nextspawn pos4-5 pos7-8)
    (nextspawn pos7-8 pos3-2)
    (nextspawn pos3-2 pos0-0)
    (nextspawn pos0-0 pos4-7)
    (nextspawn pos4-7 pos4-8)
    (nextspawn pos4-8 pos3-0)
    (nextspawn pos3-0 pos6-2)
