(define (problem snake-empty-9x9-1-5-49-22470)
(:domain snake)
(:objects
...
(:init
    ...
    (nextspawn pos6-2 pos8-8)
    (nextspawn pos8-8 pos2-5)
    (nextspawn pos2-5 pos8-5)
    (nextspawn pos8-5 pos5-3)
    (nextspawn pos5-3 pos4-6)
    (nextspawn pos4-6 pos0-5)
    (nextspawn pos0-5 pos6-6)
    (nextspawn pos6-6 pos1-8)
    (nextspawn pos1-8 pos4-3)
    (nextspawn pos4-3 pos4-8)
    (nextspawn pos4-8 pos0-8)
    (nextspawn pos0-8 pos2-1)
    (nextspawn pos2-1 pos6-4)
    (nextspawn pos6-4 pos2-3)
    (nextspawn pos2-3 pos7-1)
    (nextspawn pos7-1 pos2-0)
    (nextspawn pos2-0 pos6-0)
    (nextspawn pos6-0 pos0-3)
    (nextspawn pos0-3 pos8-7)
    (nextspawn pos8-7 pos5-0)
    (nextspawn pos5-0 pos2-6)
    (nextspawn pos2-6 pos5-1)
    (nextspawn pos5-1 pos7-2)
    (nextspawn pos7-2 pos6-8)
    (nextspawn pos6-8 pos3-4)
    (nextspawn pos3-4 pos7-6)
    (nextspawn pos7-6 pos3-6)
    (nextspawn pos3-6 pos5-5)
    (nextspawn pos5-5 pos2-2)
    (nextspawn pos2-2 pos5-7)
    (nextspawn pos5-7 pos3-7)
    (nextspawn pos3-7 pos6-5)
    (nextspawn pos6-5 pos1-6)
    (nextspawn pos1-6 pos8-1)
    (nextspawn pos8-1 pos7-7)
    (nextspawn pos7-7 pos0-7)
    (nextspawn pos0-7 pos7-0)
    (nextspawn pos7-0 pos3-3)
    (nextspawn pos3-3 pos5-4)
    (nextspawn pos5-4 pos6-7)
    (nextspawn pos6-7 pos3-1)
    (nextspawn pos3-1 pos8-6)
    (nextspawn pos8-6 pos8-0)
    (nextspawn pos8-0 pos1-1)
    (nextspawn pos1-1 pos5-8)
    (nextspawn pos5-8 pos4-5)
    (nextspawn pos4-5 pos0-1)
