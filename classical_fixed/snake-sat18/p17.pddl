(define (problem snake-empty-9x9-1-5-37-22455)
(:domain snake)
(:objects
...
(:init
    ...
    (tailsnake pos6-4)
    (headsnake pos5-4)
    (nextsnake pos5-4 pos6-4)
    (blocked pos5-4)
    (blocked pos6-4)
    (spawn pos7-7)
    (nextspawn pos4-1 dummypoint)
    (nextspawn pos7-7 pos7-1)
    (nextspawn pos7-1 pos1-3)
    (nextspawn pos1-3 pos1-4)
    (nextspawn pos1-4 pos3-4)
    (nextspawn pos3-4 pos8-7)
    (nextspawn pos8-7 pos8-1)
    (nextspawn pos8-1 pos1-0)
    (nextspawn pos1-0 pos2-5)
    (nextspawn pos2-5 pos3-0)
    (nextspawn pos3-0 pos2-2)
    (nextspawn pos2-2 pos5-8)
    (nextspawn pos5-8 pos0-1)
    (nextspawn pos0-1 pos4-3)
    (nextspawn pos4-3 pos0-5)
    (nextspawn pos0-5 pos5-2)
    (nextspawn pos5-2 pos3-7)
    (nextspawn pos3-7 pos0-3)
    (nextspawn pos0-3 pos3-8)
    (nextspawn pos3-8 pos4-8)
    (nextspawn pos4-8 pos0-7)
    (nextspawn pos0-7 pos0-2)
    (nextspawn pos0-2 pos7-4)
    (nextspawn pos7-4 pos2-6)
    (nextspawn pos2-6 pos3-2)
    (nextspawn pos3-2 pos2-4)
    (nextspawn pos2-4 pos8-0)
    (nextspawn pos8-0 pos8-6)
    (nextspawn pos8-6 pos8-3)
    (nextspawn pos8-3 pos6-3)
    (nextspawn pos6-3 pos6-0)
    (nextspawn pos6-0 pos8-8)
    (nextspawn pos8-8 pos7-5)
    (nextspawn pos7-5 pos4-2)
    (nextspawn pos4-2 pos6-6)
    (nextspawn pos6-6 pos8-2)
    (nextspawn pos8-2 pos4-1)
    (ispoint pos7-6)
    (ispoint pos7-0)
    (ispoint pos6-2)
    (ispoint pos5-6)
