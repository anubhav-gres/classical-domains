(define (problem snake-empty-9x9-1-5-61-22485)
(:domain snake)
(:objects
...
(:init
    ...
    (tailsnake pos2-5)
    (headsnake pos1-5)
    (nextsnake pos1-5 pos2-5)
    (blocked pos1-5)
    (blocked pos2-5)
    (spawn pos6-0)
    (nextspawn pos4-8 dummypoint)
    (nextspawn pos6-0 pos1-2)
    (nextspawn pos1-2 pos1-8)
    (nextspawn pos1-8 pos6-3)
    (nextspawn pos6-3 pos4-5)
    (nextspawn pos4-5 pos8-4)
    (nextspawn pos8-4 pos8-8)
    (nextspawn pos8-8 pos1-3)
    (nextspawn pos1-3 pos3-6)
    (nextspawn pos3-6 pos6-7)
    (nextspawn pos6-7 pos3-3)
    (nextspawn pos3-3 pos2-2)
    (nextspawn pos2-2 pos0-3)
    (nextspawn pos0-3 pos3-7)
    (nextspawn pos3-7 pos8-5)
    (nextspawn pos8-5 pos8-6)
    (nextspawn pos8-6 pos6-1)
    (nextspawn pos6-1 pos5-4)
    (nextspawn pos5-4 pos7-1)
    (nextspawn pos7-1 pos5-8)
    (nextspawn pos5-8 pos7-4)
    (nextspawn pos7-4 pos4-2)
    (nextspawn pos4-2 pos2-4)
    (nextspawn pos2-4 pos6-4)
    (nextspawn pos6-4 pos3-0)
    (nextspawn pos3-0 pos3-5)
    (nextspawn pos3-5 pos0-6)
    (nextspawn pos0-6 pos4-6)
    (nextspawn pos4-6 pos7-7)
    (nextspawn pos7-7 pos5-3)
    (nextspawn pos5-3 pos6-8)
    (nextspawn pos6-8 pos8-1)
    (nextspawn pos8-1 pos0-0)
    (nextspawn pos0-0 pos6-5)
    (nextspawn pos6-5 pos1-1)
    (nextspawn pos1-1 pos4-0)
    (nextspawn pos4-0 pos8-7)
    (nextspawn pos8-7 pos3-2)
    (nextspawn pos3-2 pos1-4)
    (nextspawn pos1-4 pos7-2)
    (nextspawn pos7-2 pos1-7)
    (nextspawn pos1-7 pos4-1)
    (nextspawn pos4-1 pos0-5)
    (nextspawn pos0-5 pos0-7)
    (nextspawn pos0-7 pos5-2)
    (nextspawn pos5-2 pos0-1)
    (nextspawn pos0-1 pos2-7)
    (nextspawn pos2-7 pos0-8)
    (nextspawn pos0-8 pos5-6)
    (nextspawn pos5-6 pos3-1)
    (nextspawn pos3-1 pos6-2)
    (nextspawn pos6-2 pos1-0)
    (nextspawn pos1-0 pos0-2)
    (nextspawn pos0-2 pos5-7)
    (nextspawn pos5-7 pos7-8)
    (nextspawn pos7-8 pos2-0)
    (nextspawn pos2-0 pos5-1)
    (nextspawn pos5-1 pos2-8)
