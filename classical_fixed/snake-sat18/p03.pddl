(define (problem snake-empty-6x6-1-5-23-22185)
(:domain snake)
(:objects
...
(:init
    ...
    (nextspawn pos3-5 pos0-1)
    (nextspawn pos0-1 pos3-4)
    (nextspawn pos3-4 pos2-2)
    (nextspawn pos2-2 pos2-1)
    (nextspawn pos2-1 pos1-3)
    (nextspawn pos1-3 pos2-5)
    (nextspawn pos2-5 pos3-0)
    (nextspawn pos3-0 pos1-2)
    (nextspawn pos1-2 pos5-2)
    (nextspawn pos5-2 pos0-2)
    (nextspawn pos0-2 pos5-3)
    (nextspawn pos5-3 pos5-4)
    (nextspawn pos5-4 pos4-1)
    (nextspawn pos4-1 pos2-3)
    (nextspawn pos2-3 pos0-5)
    (nextspawn pos0-5 pos4-3)
    (nextspawn pos4-3 pos4-4)
    (nextspawn pos4-4 pos4-2)
    (nextspawn pos4-2 pos5-1)
    (nextspawn pos5-1 pos1-0)
    (nextspawn pos1-0 pos3-2)
