(define (problem p22-3-41-ring-network-33)
(:domain data-network)
(:objects
    data-0-1 data-0-8 data-0-9 data-0-14 data-0-15 data-0-17 data-0-18 data-0-20 data-1-2 data-1-5 data-1-6 data-1-12 data-1-16 data-1-21 data-2-3 data-2-4 data-2-7 data-2-10 data-2-11 data-2-13 data-2-19 data-2-22 - data
    script1 script2 script3 script4 script5 script6 script7 script8 script9 script10 script11 script12 script13 script14 script15 script16 script17 script18 script19 script20 script21 script22 script23 script24 script25 script26 script27 script28 script29 script30 script31 script32 script33 script34 script35 script36 script37 script38 script39 script40 script41 - script
...
(:init
    (script-io script1 data-0-8 data-0-17 data-1-21)
    (script-io script2 data-0-1 data-0-18 data-1-5)
    (script-io script3 data-0-9 data-0-14 data-1-6)
    (script-io script4 data-0-9 data-0-17 data-1-2)
    (script-io script5 data-0-18 data-0-9 data-1-16)
    (script-io script6 data-0-1 data-0-9 data-1-12)
    (script-io script7 data-1-16 data-0-8 data-2-22)
    (script-io script8 data-1-16 data-0-18 data-2-4)
    (script-io script9 data-1-2 data-0-1 data-2-7)
    (script-io script10 data-1-12 data-0-20 data-2-3)
    (script-io script11 data-1-21 data-1-12 data-2-19)
    (script-io script12 data-1-6 data-1-5 data-2-11)
    (script-io script13 data-1-16 data-0-9 data-2-10)
    (script-io script14 data-1-5 data-1-2 data-2-13)
    (script-io script15 data-1-12 data-0-1 data-2-3)
    (script-io script16 data-1-2 data-0-1 data-2-7)
    (script-io script17 data-1-21 data-1-16 data-2-22)
    (script-io script18 data-0-18 data-0-1 data-1-16)
    (script-io script19 data-0-20 data-0-15 data-1-16)
    (script-io script20 data-1-2 data-0-1 data-2-11)
    (script-io script21 data-0-15 data-0-14 data-1-6)
    (script-io script22 data-0-17 data-0-1 data-1-12)
    (script-io script23 data-0-17 data-0-18 data-1-2)
    (script-io script24 data-0-1 data-0-8 data-1-5)
    (script-io script25 data-1-12 data-0-8 data-2-13)
    (script-io script26 data-0-17 data-0-14 data-1-16)
    (script-io script27 data-1-5 data-0-17 data-2-11)
    (script-io script28 data-1-6 data-0-14 data-2-4)
    (script-io script29 data-1-21 data-0-18 data-2-13)
    (script-io script30 data-0-17 data-0-15 data-1-2)
    (script-io script31 data-0-1 data-0-18 data-1-16)
    (script-io script32 data-0-9 data-0-15 data-1-5)
    (script-io script33 data-0-1 data-0-15 data-1-5)
    (script-io script34 data-0-1 data-0-20 data-1-6)
    (script-io script35 data-0-20 data-0-17 data-1-5)
    (script-io script36 data-0-14 data-0-18 data-1-16)
    (script-io script37 data-0-17 data-0-20 data-1-12)
    (script-io script38 data-0-20 data-0-17 data-1-5)
    (script-io script39 data-0-15 data-0-20 data-1-16)
    (script-io script40 data-0-8 data-0-18 data-1-21)
    (script-io script41 data-1-2 data-1-12 data-2-10)
    ...
    (= (process-cost script3 server5) 32)
    ...
    (= (process-cost script9 server4) 11)
    ...
    (= (process-cost script12 server4) 16)
    ...
    (= (process-cost script15 server6) 15)
    (= (process-cost script15 server7) 27)
    ...
    (= (process-cost script16 server6) 12)
    (= (process-cost script16 server7) 25)
    ...
    (= (process-cost script18 server2) 14)
    ...
    (= (process-cost script18 server7) 12)
    ...
    (= (process-cost script21 server7) 26)
    ...
    (= (process-cost script25 server7) 23)
    ...
    (= (process-cost script27 server6) 30)
    ...
    (= (process-cost script30 server5) 13)
    ...
    (= (process-cost script32 server6) 29)
    ...
    (= (process-cost script34 server6) 26)
    ...
    (= (process-cost script35 server7) 27)
    ...
    (= (process-cost script36 server7) 24)
    ...
    (= (process-cost script38 server2) 20)
    ...
    (= (process-cost script41 server7) 28)
