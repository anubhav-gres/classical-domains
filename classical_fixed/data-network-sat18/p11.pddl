(define (problem p10-3-27-ring-network-30)
(:domain data-network)
(:objects
    data-0-1 data-0-2 data-0-4 data-0-9 data-0-10 data-1-8 data-2-3 data-2-5 data-2-6 data-2-7 - data
...
(:init
    (script-io script1 data-0-9 data-0-10 data-1-8)
    (script-io script2 data-1-8 data-0-9 data-2-5)
    (script-io script3 data-1-8 data-0-10 data-2-7)
    (script-io script4 data-1-8 data-0-1 data-2-6)
    (script-io script5 data-1-8 data-0-4 data-2-3)
    (script-io script6 data-0-10 data-0-4 data-1-8)
    (script-io script7 data-0-10 data-0-2 data-1-8)
    (script-io script8 data-1-8 data-0-2 data-2-3)
    (script-io script9 data-0-9 data-0-4 data-1-8)
    (script-io script10 data-0-9 data-0-4 data-1-8)
    (script-io script11 data-0-1 data-0-10 data-1-8)
    (script-io script12 data-1-8 data-0-2 data-2-6)
    (script-io script13 data-1-8 data-0-2 data-2-6)
    (script-io script14 data-0-10 data-0-4 data-1-8)
    (script-io script15 data-0-9 data-0-4 data-1-8)
    (script-io script16 data-1-8 data-0-2 data-2-3)
    (script-io script17 data-0-2 data-0-1 data-1-8)
    (script-io script18 data-1-8 data-0-4 data-2-3)
    (script-io script19 data-1-8 data-0-9 data-2-3)
    (script-io script20 data-1-8 data-0-10 data-2-5)
    (script-io script21 data-0-2 data-0-10 data-1-8)
    (script-io script22 data-1-8 data-0-10 data-2-5)
    (script-io script23 data-1-8 data-0-2 data-2-3)
    (script-io script24 data-1-8 data-0-1 data-2-7)
    (script-io script25 data-0-2 data-0-10 data-1-8)
    (script-io script26 data-0-1 data-0-4 data-1-8)
    (script-io script27 data-0-10 data-0-2 data-1-8)
    ...
    (= (process-cost script10 server6) 15)
    (= (process-cost script10 server7) 16)
    (= (process-cost script11 server1) 7)
    (= (process-cost script11 server2) 16)
    ...
    (= (process-cost script12 server4) 14)
    ...
    (= (process-cost script15 server7) 28)
    ...
    (= (process-cost script19 server6) 16)
    ...
    (= (process-cost script23 server7) 24)
    ...
    (= (process-cost script26 server2) 24)
