(define (problem p28-3-35-small-network-22)
(:domain data-network)
(:objects
    data-0-1 data-0-6 data-0-10 data-0-12 data-0-14 data-0-22 data-0-26 data-0-27 data-0-28 data-1-2 data-1-3 data-1-5 data-1-7 data-1-8 data-1-9 data-1-11 data-1-13 data-1-15 data-1-16 data-1-17 data-1-18 data-1-19 data-1-20 data-1-23 data-1-25 data-2-4 data-2-21 data-2-24 - data
    script1 script2 script3 script4 script5 script6 script7 script8 script9 script10 script11 script12 script13 script14 script15 script16 script17 script18 script19 script20 script21 script22 script23 script24 script25 script26 script27 script28 script29 script30 script31 script32 script33 script34 script35 - script
...
(:init
    (script-io script1 data-0-27 data-0-6 data-1-20)
    (script-io script2 data-0-28 data-0-26 data-1-23)
    (script-io script3 data-0-27 data-0-14 data-1-25)
    (script-io script4 data-0-28 data-0-10 data-1-9)
    (script-io script5 data-0-1 data-0-28 data-1-8)
    (script-io script6 data-0-1 data-0-12 data-1-5)
    (script-io script7 data-0-22 data-0-12 data-1-7)
    (script-io script8 data-0-12 data-0-27 data-1-3)
    (script-io script9 data-0-22 data-0-1 data-1-2)
    (script-io script10 data-0-14 data-0-1 data-1-19)
    (script-io script11 data-0-14 data-0-26 data-1-18)
    (script-io script12 data-0-1 data-0-14 data-1-15)
    (script-io script13 data-0-28 data-0-1 data-1-17)
    (script-io script14 data-0-22 data-0-26 data-1-16)
    (script-io script15 data-0-28 data-0-27 data-1-11)
    (script-io script16 data-0-1 data-0-10 data-1-13)
    (script-io script17 data-1-7 data-1-17 data-2-21)
    (script-io script18 data-1-2 data-0-12 data-2-24)
    (script-io script19 data-1-19 data-0-1 data-2-4)
    (script-io script20 data-1-8 data-0-27 data-2-24)
    (script-io script21 data-0-12 data-0-6 data-1-13)
    (script-io script22 data-0-1 data-0-14 data-1-23)
    (script-io script23 data-0-14 data-0-1 data-1-25)
    (script-io script24 data-0-14 data-0-10 data-1-18)
    (script-io script25 data-1-8 data-1-11 data-2-21)
    (script-io script26 data-1-23 data-0-27 data-2-21)
    (script-io script27 data-0-27 data-0-14 data-1-20)
    (script-io script28 data-1-8 data-0-12 data-2-4)
    (script-io script29 data-1-9 data-1-3 data-2-24)
    (script-io script30 data-1-7 data-0-12 data-2-24)
    (script-io script31 data-0-1 data-0-28 data-1-18)
    (script-io script32 data-0-22 data-0-14 data-1-13)
    (script-io script33 data-1-20 data-1-17 data-2-24)
    (script-io script34 data-0-28 data-0-10 data-1-5)
    (script-io script35 data-0-14 data-0-12 data-1-17)
    ...
    (= (process-cost script5 server3) 5)
    ...
    (= (process-cost script11 server1) 24)
    ...
    (= (process-cost script13 server1) 31)
    ...
    (= (process-cost script18 server4) 4)
    ...
    (= (process-cost script21 server1) 32)
    (= (process-cost script21 server2) 14)
    (= (process-cost script21 server3) 8)
    (= (process-cost script21 server4) 8)
    ...
    (= (process-cost script24 server4) 9)
    ...
    (= (process-cost script28 server4) 6)
...
(:goal
(and
    (saved data-1-5 server4)
    (saved data-1-13 server2)
    (saved data-1-15 server2)
    (saved data-1-16 server1)
    (saved data-1-18 server4)
    (saved data-1-25 server3)
