(define (problem p32-3-37-small-network-23)
(:domain data-network)
(:objects
    data-0-1 data-0-8 data-0-14 data-0-19 data-0-21 data-0-24 data-0-26 data-0-27 data-0-28 data-0-30 data-0-32 data-1-3 data-1-9 data-1-10 data-1-12 data-1-25 data-1-29 data-2-2 data-2-4 data-2-5 data-2-6 data-2-7 data-2-11 data-2-13 data-2-15 data-2-16 data-2-17 data-2-18 data-2-20 data-2-22 data-2-23 data-2-31 - data
    script1 script2 script3 script4 script5 script6 script7 script8 script9 script10 script11 script12 script13 script14 script15 script16 script17 script18 script19 script20 script21 script22 script23 script24 script25 script26 script27 script28 script29 script30 script31 script32 script33 script34 script35 script36 script37 - script
...
(:init
    (script-io script1 data-0-27 data-0-14 data-1-29)
    (script-io script2 data-0-32 data-0-14 data-1-25)
    (script-io script3 data-0-26 data-0-8 data-1-9)
    (script-io script4 data-0-8 data-0-1 data-1-3)
    (script-io script5 data-0-27 data-0-1 data-1-10)
    (script-io script6 data-0-30 data-0-8 data-1-12)
    (script-io script7 data-1-29 data-0-27 data-2-20)
    (script-io script8 data-1-3 data-1-25 data-2-22)
    (script-io script9 data-1-10 data-0-8 data-2-23)
    (script-io script10 data-1-25 data-1-29 data-2-5)
    (script-io script11 data-1-25 data-0-28 data-2-4)
    (script-io script12 data-1-12 data-1-9 data-2-7)
    (script-io script13 data-1-12 data-0-1 data-2-6)
    (script-io script14 data-1-10 data-1-29 data-2-2)
    (script-io script15 data-1-9 data-1-3 data-2-31)
    (script-io script16 data-1-25 data-0-24 data-2-18)
    (script-io script17 data-1-10 data-0-27 data-2-15)
    (script-io script18 data-1-3 data-0-27 data-2-17)
    (script-io script19 data-1-29 data-0-30 data-2-16)
    (script-io script20 data-1-25 data-1-12 data-2-11)
    (script-io script21 data-1-25 data-1-10 data-2-13)
    (script-io script22 data-0-30 data-0-28 data-1-25)
    (script-io script23 data-1-25 data-0-24 data-2-17)
    (script-io script24 data-0-28 data-0-24 data-1-29)
    (script-io script25 data-0-24 data-0-30 data-1-9)
    (script-io script26 data-1-12 data-0-1 data-2-22)
    (script-io script27 data-0-32 data-0-1 data-1-9)
    (script-io script28 data-1-12 data-0-32 data-2-31)
    (script-io script29 data-1-9 data-0-26 data-2-16)
    (script-io script30 data-1-25 data-0-8 data-2-13)
    (script-io script31 data-1-3 data-0-28 data-2-22)
    (script-io script32 data-0-26 data-0-32 data-1-12)
    (script-io script33 data-0-28 data-0-26 data-1-9)
    (script-io script34 data-1-29 data-1-25 data-2-4)
    (script-io script35 data-0-21 data-0-26 data-1-9)
    (script-io script36 data-1-9 data-1-10 data-2-23)
    (script-io script37 data-0-1 data-0-19 data-1-25)
    ...
    (= (process-cost script3 server4) 8)
    ...
    (= (process-cost script6 server4) 7)
    ...
    (= (process-cost script19 server4) 5)
    ...
    (= (process-cost script22 server4) 5)
    ...
    (= (process-cost script25 server4) 8)
    ...
    (= (process-cost script27 server1) 27)
    ...
    (= (process-cost script29 server1) 15)
    (= (process-cost script29 server2) 11)
    (= (process-cost script29 server3) 9)
    (= (process-cost script29 server4) 9)
    (= (process-cost script30 server1) 13)
    ...
    (= (process-cost script37 server1) 24)
...
(and
    ...
    (saved data-2-18 server4)
    (saved data-2-20 server4)
    (saved data-2-22 server2)
    (saved data-2-23 server1)
