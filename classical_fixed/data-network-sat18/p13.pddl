(define (problem p18-3-40-ring-network-32)
(:domain data-network)
(:objects
    data-0-3 data-0-9 data-0-11 data-0-12 data-0-14 data-0-18 data-1-1 data-1-4 data-1-5 data-1-7 data-1-16 data-2-2 data-2-6 data-2-8 data-2-10 data-2-13 data-2-15 data-2-17 - data
    script1 script2 script3 script4 script5 script6 script7 script8 script9 script10 script11 script12 script13 script14 script15 script16 script17 script18 script19 script20 script21 script22 script23 script24 script25 script26 script27 script28 script29 script30 script31 script32 script33 script34 script35 script36 script37 script38 script39 script40 - script
...
(:init
    (script-io script1 data-0-3 data-0-14 data-1-16)
    (script-io script2 data-0-3 data-0-9 data-1-5)
    (script-io script3 data-0-12 data-0-18 data-1-4)
    (script-io script4 data-0-14 data-0-11 data-1-7)
    (script-io script5 data-0-12 data-0-18 data-1-1)
    (script-io script6 data-1-4 data-1-16 data-2-13)
    (script-io script7 data-1-7 data-1-4 data-2-17)
    (script-io script8 data-1-4 data-1-7 data-2-15)
    (script-io script9 data-1-5 data-0-14 data-2-8)
    (script-io script10 data-1-16 data-0-9 data-2-6)
    (script-io script11 data-1-5 data-1-4 data-2-10)
    (script-io script12 data-1-4 data-0-9 data-2-2)
    (script-io script13 data-0-3 data-0-9 data-1-5)
    (script-io script14 data-1-16 data-0-3 data-2-2)
    (script-io script15 data-1-16 data-0-18 data-2-17)
    (script-io script16 data-1-7 data-1-16 data-2-6)
    (script-io script17 data-0-9 data-0-11 data-1-4)
    (script-io script18 data-0-11 data-0-14 data-1-1)
    (script-io script19 data-0-11 data-0-9 data-1-5)
    (script-io script20 data-1-16 data-1-1 data-2-15)
    (script-io script21 data-0-12 data-0-9 data-1-16)
    (script-io script22 data-0-9 data-0-14 data-1-7)
    (script-io script23 data-0-3 data-0-12 data-1-4)
    (script-io script24 data-1-1 data-1-4 data-2-6)
    (script-io script25 data-1-7 data-1-5 data-2-13)
    (script-io script26 data-0-18 data-0-11 data-1-16)
    (script-io script27 data-1-1 data-1-5 data-2-13)
    (script-io script28 data-0-3 data-0-12 data-1-16)
    (script-io script29 data-0-3 data-0-11 data-1-7)
    (script-io script30 data-0-12 data-0-11 data-1-4)
    (script-io script31 data-1-1 data-0-9 data-2-8)
    (script-io script32 data-1-1 data-1-4 data-2-10)
    (script-io script33 data-1-1 data-0-3 data-2-6)
    (script-io script34 data-0-9 data-0-14 data-1-5)
    (script-io script35 data-0-12 data-0-3 data-1-5)
    (script-io script36 data-0-14 data-0-18 data-1-1)
    (script-io script37 data-0-11 data-0-9 data-1-5)
    (script-io script38 data-0-11 data-0-3 data-1-7)
    (script-io script39 data-1-5 data-1-7 data-2-15)
    (script-io script40 data-1-1 data-0-3 data-2-10)
    ...
    (= (process-cost script1 server5) 27)
    ...
    (= (process-cost script2 server6) 14)
    ...
    (= (process-cost script3 server4) 13)
    (= (process-cost script3 server5) 19)
    (= (process-cost script3 server6) 19)
    ...
    (= (process-cost script5 server6) 29)
    (= (process-cost script5 server7) 8)
    (= (process-cost script6 server1) 5)
    ...
    (= (process-cost script9 server5) 17)
    ...
    (= (process-cost script10 server5) 25)
    ...
    (= (process-cost script12 server2) 28)
    ...
    (= (process-cost script13 server7) 10)
    (= (process-cost script14 server1) 12)
    (= (process-cost script14 server2) 17)
    ...
    (= (process-cost script15 server5) 12)
    (= (process-cost script15 server6) 19)
    ...
    (= (process-cost script17 server2) 26)
    ...
    (= (process-cost script17 server7) 28)
    (= (process-cost script18 server1) 12)
    (= (process-cost script18 server2) 31)
    ...
    (= (process-cost script20 server3) 28)
    ...
    (= (process-cost script21 server2) 26)
    ...
    (= (process-cost script21 server7) 28)
    ...
    (= (process-cost script22 server7) 28)
    (= (process-cost script23 server1) 10)
    (= (process-cost script23 server2) 13)
    (= (process-cost script23 server3) 13)
    (= (process-cost script23 server4) 30)
    ...
    (= (process-cost script26 server4) 23)
    ...
    (= (process-cost script29 server4) 13)
    ...
    (= (process-cost script32 server2) 16)
    (= (process-cost script32 server3) 25)
    ...
    (= (process-cost script33 server4) 26)
    ...
    (= (process-cost script35 server7) 12)
    (= (process-cost script36 server1) 8)
    (= (process-cost script36 server2) 25)
    (= (process-cost script36 server3) 15)
    (= (process-cost script36 server4) 6)
    ...
    (= (process-cost script39 server2) 27)
    ...
    (= (process-cost script39 server7) 15)
    (= (process-cost script40 server1) 9)
    (= (process-cost script40 server2) 15)
    (= (process-cost script40 server3) 24)
