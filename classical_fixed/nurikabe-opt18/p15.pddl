(define (problem random-10x10-252)
(:domain nurikabe)
(:objects
    ...
    g0 g1 g2 g3 g4 g5 g6 g7 g8 g9 g10 g11 g12 g13 g14 - group
)
(:init
    (next n0 n1)
    (next n1 n2)
    ...
    (remaining-cells g12 n8)
    (remaining-cells g13 n2)
    (remaining-cells g14 n3)
)
(:goal
(and
    (group-painted g0)
