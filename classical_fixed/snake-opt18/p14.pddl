(define (problem snake-empty-6x6-1-5-29-113100)
(:domain snake)
(:objects
...
(:init
    ...
    (nextspawn pos1-0 pos4-4)
    (nextspawn pos4-4 pos1-2)
    (nextspawn pos1-2 pos0-3)
    (nextspawn pos0-3 pos3-4)
    (nextspawn pos3-4 pos3-3)
    (nextspawn pos3-3 pos4-1)
    (nextspawn pos4-1 pos5-4)
    (nextspawn pos5-4 pos5-0)
    (nextspawn pos5-0 pos5-3)
    (nextspawn pos5-3 pos0-4)
    (nextspawn pos0-4 pos2-0)
    (nextspawn pos2-0 pos2-3)
    (nextspawn pos2-3 pos4-2)
    (nextspawn pos4-2 pos1-1)
    (nextspawn pos1-1 pos4-5)
    (nextspawn pos4-5 pos3-2)
    (nextspawn pos3-2 pos4-0)
    (nextspawn pos4-0 pos0-1)
    (nextspawn pos0-1 pos2-5)
    (ispoint pos1-3)
    (ispoint pos3-0)
    (ispoint pos0-0)
    (ispoint pos5-5)
